...
inline std::string DebugPrint(BookmarkIcon icon) { return ToString(icon); }

inline std::string DebugPrint(TimestampMillis const & ts) { return ::DebugPrint(static_cast<Timestamp>(ts)); }
