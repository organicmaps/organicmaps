...
UNIT_TEST(Gpx_ImportExport_Test) { ImportExportCompare("test_data/gpx/export_test.gpx"); }

UNIT_TEST(Gpx_ImportExportEmpty_Test) { ImportExportCompare("test_data/gpx/export_test_empty.gpx"); }
