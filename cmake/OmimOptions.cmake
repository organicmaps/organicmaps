...
if (CMAKE_UNITY_BUILD)
  set(recommended_virt_mb 13000)
  cmake_host_system_information(RESULT available_ram_mb QUERY AVAILABLE_PHYSICAL_MEMORY)
  cmake_host_system_information(RESULT available_swap_mb QUERY AVAILABLE_VIRTUAL_MEMORY)
  math(EXPR available_virt_mb "${available_ram_mb} + ${available_swap_mb}")
  if (available_virt_mb GREATER_EQUAL recommended_virt_mb)
    set(CMAKE_UNITY_BUILD_BATCH_SIZE "50" CACHE STRING "Batch size for unity build")
  else ()
    message(STATUS "Virtual memory: ${available_virt_mb} MiB out of recommended ${recommended_virt_mb} MiB is available.")
    message(STATUS "Using Unity Build with batch 8 by default, use -DCMAKE_UNITY_BUILD_BATCH_SIZE=<size> to override.")
    message(WARNING "Low memory: build speed may be not optimal.")
  endif ()
endif ()
