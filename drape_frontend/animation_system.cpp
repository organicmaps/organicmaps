...
void AnimationSystem::UpdateLastScreen(ScreenBase const & currentScreen) { m_lastScreen = currentScreen; }
...
bool AnimationSystem::HasAnimations() const { return !m_animationChain.empty(); }
