...
void LineShape::Construct<SolidLineBuilder>(SolidLineBuilder & builder) const
{
  ...
  ForEachSplineSection(
    [&](glsl::vec2 const & p1, glsl::vec2 const & p2, glsl::vec2 const & tangent, double, glsl::vec2 const & leftNormal,
        glsl::vec2 const & rightNormal, int flag)
    {
