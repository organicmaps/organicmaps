                                        ...
                                        dp::text::TextMetrics const & str)
{
  ...
  lines.push_back(LineMetrics{
    count, textScale * std::accumulate(afterSpace, end, 0, [](auto acc, auto const & m) { return m.m_xAdvance + acc; }),
...
float TextLayout::GetPixelLength() const { return m_shapedGlyphs.m_lineWidthInPixels * m_textSizeRatio; }

float TextLayout::GetPixelHeight() const { return m_shapedGlyphs.m_maxLineHeightInPixels * m_textSizeRatio; }
