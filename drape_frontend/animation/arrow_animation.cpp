...
Animation::TAnimObjects const & ArrowAnimation::GetObjects() const { return m_objects; }

bool ArrowAnimation::HasObject(Object object) const { return object == Animation::Object::MyPositionArrow; }

Animation::TObjectProperties const & ArrowAnimation::GetProperties(Object object) const { return m_properties; }
...
bool ArrowAnimation::GetProperty(Object object, ObjectProperty property, bool targetValue, PropertyValue & value) const
{
  ...
  case Animation::ObjectProperty::Position:
    ...
    {
      value =
        PropertyValue(targetValue ? m_positionInterpolator.GetTargetPosition() : m_positionInterpolator.GetPosition());
      return true;
    }
    return false;
