...
public:
  SMAAFinalRenderParams()
    : TBase(gpu::Program::SmaaFinal)
  {}
...
PostprocessRenderer::~PostprocessRenderer() { ClearContextDependentResources(); }
...
StencilWriterGuard::~StencilWriterGuard() { m_renderer->DisableWritingToStencil(m_context); }
}  // namespace df
