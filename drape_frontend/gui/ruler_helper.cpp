...
void RulerHelper::Invalidate() { SetTextDirty(); }
...
float RulerHelper::GetRulerPixelLength() const { return m_pixelLength; }

// static
float RulerHelper::GetMaxRulerPixelLength() { return kMinPixelWidth * 3.0f / 2.0f; }
...
bool RulerHelper::IsTextDirty() const { return m_isTextDirty; }
