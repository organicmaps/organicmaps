...
BackendRenderer::~BackendRenderer() { ASSERT(m_isTeardowned, ()); }
...
std::unique_ptr<threads::IRoutine> BackendRenderer::CreateRoutine() { return std::make_unique<Routine>(*this); }
...
BackendRenderer::Routine::Routine(BackendRenderer & renderer)
  : m_renderer(renderer)
{}
