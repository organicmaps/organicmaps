...
namespace df
{
  ...
  const string & VisualParams::GetResourcePostfix() const
  {
  ...
  const m2::RectD & GetWorldRect()
  {
    static m2::RectD const worldRect = MercatorBounds::FullRect();
    return worldRect;
  }

  int GetTileScaleBase(const ScreenBase & s)
  {
    ScreenBase tmpS = s;
  ...
  int GetTileScaleBase(const m2::RectD & r)
  {
  ...
  m2::RectD GetRectForDrawScale(int drawScale, const m2::PointD & center)
  {
  ...
  m2::RectD GetRectForDrawScale(double drawScale, const m2::PointD & center)
  {
  ...
  int GetDrawTileScale(const ScreenBase & s)
  {
    return GetDrawTileScale(GetTileScaleBase(s));
  }

  int GetDrawTileScale(const m2::RectD & r)
  {
