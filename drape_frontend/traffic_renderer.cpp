                                    ...
                                    TrafficRenderData && renderData)
{
  ...
  m_renderData.erase(
    std::remove_if(m_renderData.begin(), m_renderData.end(), [&tileKey](TrafficRenderData const & rd)
...
{
  m_renderData.erase(
    std::remove_if(m_renderData.begin(), m_renderData.end(),
...
void TrafficRenderer::ClearContextDependentResources() { m_renderData.clear(); }
