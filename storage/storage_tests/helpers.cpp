...
bool AlmostEqualRectsAbs(m2::RectD const & r1, m2::RectD const & r2)
{
  ...
  return base::AlmostEqualAbs(r1.maxX(), r2.maxX(), kEpsilon) && base::AlmostEqualAbs(r1.maxY(), r2.maxY(), kEpsilon) &&
         base::AlmostEqualAbs(r1.minX(), r2.minX(), kEpsilon) && base::AlmostEqualAbs(r1.minY(), r2.minY(), kEpsilon);
}
}  // namespace storage
