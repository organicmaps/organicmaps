...
ScreenBase::MatrixT const ScreenBase::CalcTransform(m2::PointD const & oldPt1, m2::PointD const & oldPt2,
...
m2::PointD ScreenBase::P3dtoP(m2::PointD const & pt) const { return P3dtoP(pt, 0.0 /* ptZ */); }
