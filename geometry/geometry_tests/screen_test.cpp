...
static void check_set_from_rect(ScreenBase & screen, int width, int height)
{
  ...
  TEST(base::Between(0, width, static_cast<int>(std::lround(b1.x))), ());
  TEST(base::Between(0, width, static_cast<int>(std::lround(b2.x))), ());
  TEST(base::Between(0, height, static_cast<int>(std::lround(b1.y))), ());
  TEST(base::Between(0, height, static_cast<int>(std::lround(b2.y))), ());
}
