...
RectD GetBoundingBox(vector<PointD> const & points) { return m2::ApplyCalculator(points, m2::CalculateBoundingBox()); }
...
bool PointsAlmostEqual(PointD const & p1, PointD const & p2) { return p1.EqualDxDy(p2, mercator::kPointEqualityEps); }
