...
int FindResult(DataSourceBase & index, string const & mwmName, uint32_t const featureId, double const lat,
...
void CheckCompleteness(string const & path, m2::RectD const & viewport, DataSourceBase & index,
