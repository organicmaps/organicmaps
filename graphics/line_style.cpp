...
namespace graphics
{
  LineStyle::LineStyle(bool isWrapped, m2::RectU const & texRect, int pipelineID, graphics::PenInfo const & penInfo) :
  ...
  {
    graphics::PenInfo const & penInfo = m_penInfo;
    ...
    graphics::Color penInfoColor = penInfo.m_color;
