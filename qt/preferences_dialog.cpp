  ...
  : QDialog(parent, Qt::WindowTitleHint | Qt::WindowSystemMenuHint)
{
  ...
  QGroupBox * unitsRadioBox = new QGroupBox("System of measurement");
  {
    ...
    connect(unitsGroup, buttonClicked,
            [&framework](int i)
            {
  ...
  QCheckBox * transliterationCheckBox = new QCheckBox("Transliterate to Latin");
  {
    ...
    connect(transliterationCheckBox, &QCheckBox::stateChanged,
            [&framework](int i)
            {
  ...
  QComboBox * mapLanguageComboBox = new QComboBox();
  {
    ...
    connect(mapLanguageComboBox, &QComboBox::activated,
            [&framework, &supportedLanguages](int index)
            {
  ...
  QGroupBox * nightModeRadioBox = new QGroupBox("Night Mode");
  {
    ...
    void (QButtonGroup::*buttonClicked)(int) = &QButtonGroup::idClicked;
    connect(nightModeGroup, buttonClicked,
            [&framework](int i)
            {
              NightMode nightMode = static_cast<NightMode>(i);
              settings::Set(settings::kNightMode, i);
              framework.SetMapStyle((nightMode == NightMode::Off) ? GetLightMapStyleVariant(framework.GetMapStyle())
                                                                  : GetDarkMapStyleVariant(framework.GetMapStyle()));
            });
  }
