...
private:
  ...
  void SubmitRoutingPoint(m2::PointD const & pt, bool pointIsMercator = false);
  ...
  m2::PointD GetCoordsFromSettingsIfExists(bool start, m2::PointD const & pt, bool pointIsMercator = false) const;
