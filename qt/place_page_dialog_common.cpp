...
QToolBar * createActionToolBar(QWidget * parent, qt::DrawWidget * drawWidget, place_page::Info const & info)
{
  ...
  QAction * fromAction = toolBar->addAction(qt::Icon::PointStart, "Route From");
  ...
  QAction * stopAction = toolBar->addAction(qt::Icon::PointIntermediate, "Add Stop");
  ...
  QAction * toAction = toolBar->addAction(qt::Icon::PointFinish, "Route To");
