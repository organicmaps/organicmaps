...
Framework & MainWindow::GetFramework() const { return m_pDrawWidget->GetFramework(); }
...
void MainWindow::OnDownloadClicked() { GetFramework().GetStorage().DownloadNode(m_lastCountry); }

void MainWindow::OnRetryDownloadClicked() { GetFramework().GetStorage().RetryDownloadNode(m_lastCountry); }
...
void MainWindow::OnLayerEnabled(LayerType layer) { SetLayerEnabled(layer, m_layers->isChecked(layer)); }

void MainWindow::OnRulerEnabled() { m_pDrawWidget->SetRuler(m_rulerAction->isChecked()); }
...
void MainWindow::OnFollowRoute() { m_pDrawWidget->FollowRoute(); }

void MainWindow::OnClearRoute() { m_pDrawWidget->ClearRoute(); }
