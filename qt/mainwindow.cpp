...
void MainWindow::CreateNavigationBar()
{
...

  {
    ...
    m_layers->setChecked(HIKING, Framework::LoadHikingEnabled());

    m_layers->addAction(QIcon(":/navig64/isolines.png"), tr("Cycling"),
                        std::bind(&MainWindow::OnLayerEnabled, this, CYCLING), true);
    m_layers->setChecked(CYCLING, Framework::LoadCyclingEnabled());
...
void MainWindow::SetLayerEnabled(LayerType type, bool enable)
{
  ...
  case OUTDOORS:
    ...
    break;
  case HIKING:
    // TODO(AB): Enable or disable hiking layer.
    frm.SaveHikingEnabled(enable);
    break;
  case CYCLING:
    // TODO(AB): Enable or disable cycling layer.
    frm.SaveCyclingEnabled(enable);
    break;
  }
}
