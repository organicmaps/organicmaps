...
bool OsmElement::operator==(OsmElement const & other) const
{
  return m_type == other.m_type && m_id == other.m_id &&
         ...
         base::AlmostEqualAbs(m_lat, other.m_lat, mercator::kPointEqualityEps) && m_ref == other.m_ref &&
         m_k == other.m_k && m_v == other.m_v && m_memberType == other.m_memberType && m_role == other.m_role &&
         m_nodes == other.m_nodes && m_members == other.m_members && m_tags == other.m_tags;
}
