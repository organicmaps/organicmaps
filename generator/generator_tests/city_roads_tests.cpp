...
UNIT_TEST(CityRoadsGenerationTest_Empty) { TestCityRoadsBuilding(vector<uint32_t>({})); }

UNIT_TEST(CityRoadsGenerationTest_FromZero) { TestCityRoadsBuilding(vector<uint32_t>({0, 1, 10})); }

UNIT_TEST(CityRoadsGenerationTest_CommonCase) { TestCityRoadsBuilding(vector<uint32_t>({100, 203, 204, 1008, 1009})); }
