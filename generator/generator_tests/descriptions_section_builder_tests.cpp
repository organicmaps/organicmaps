...
UNIT_CLASS_TEST(TestDescriptionSectionBuilder, MakeDescriptions) { TestDescriptionSectionBuilder::MakeDescriptions(); }

UNIT_CLASS_TEST(TestDescriptionSectionBuilder, MakePath) { TestDescriptionSectionBuilder::MakePath(); }

UNIT_CLASS_TEST(TestDescriptionSectionBuilder, FindPageAndFill) { TestDescriptionSectionBuilder::FindPageAndFill(); }
