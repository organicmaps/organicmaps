...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_AlabamaRiver)
{
  Tags const tags1 = {
      ...
      {"NHD:RESOLUTION", "2"},
      {"NHD:way_id",
       "139286586;139286577;139286596;139286565;139286574;139286508;139286600;139286591;139286507;139286505;139286611;"
       "139286602;139286594;139286604;139286615;139286616;139286608;139286514;139286511;139286564;139286576;139286521;"
       "139286554"},
      {"attribution", "NHD"},
      {"boat", "yes"},
      {"deep_draft", "no"},
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_Hwtag)
{
...

  {
    ...
    TEST(params.IsTypeExist(GetType({"hwtag", "yesbicycle"})), ());
    TEST(params.IsTypeExist(GetType({"hwtag", "cycleway_lane"})), ());
  }

  {
    ...
    TEST(params.IsTypeExist(GetType({"hwtag", "yesbicycle"})), ());
    TEST(params.IsTypeExist(GetType({"hwtag", "cycleway_track"})), ());
  }
...

  {
    ...
    TEST(params.IsTypeExist(GetType({"highway", "primary"})), ());
    TEST(params.IsTypeExist(GetType({"hwtag", "yesbicycle"})), ());
    TEST(params.IsTypeExist(GetType({"hwtag", "cycleway_shared_lane"})), ());
  }
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_ComplexTypesSmoke)
{
  ...
  std::vector<std::pair<Type, Tags>> const complexTypes = {
      ...
      {{"shop", "clothes", "children"}, {{"shop", "clothes"}, {"clothes", "babies"}}},
      {{"shop", "clothes", "children"}, {{"shop", "clothes"}, {"clothes", "children"}}},
      {{"shop", "clothes", "fashion"}, {{"shop", "clothes"}, {"clothes", "fashion"}}},
      {{"shop", "clothes", "hats"}, {{"shop", "clothes"}, {"clothes", "hats"}}},
      {{"shop", "clothes", "men"}, {{"shop", "clothes"}, {"clothes", "men"}}},
      {{"shop", "clothes", "sports"}, {{"shop", "clothes"}, {"clothes", "sports"}}},
      {{"shop", "clothes", "suits"}, {{"shop", "clothes"}, {"clothes", "suits"}}},
      {{"shop", "clothes", "underwear"}, {{"shop", "clothes"}, {"clothes", "underwear"}}},
