...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_ComplexTypesSmoke)
{
  ...
  std::vector<std::pair<Type, Tags>> const complexTypes = {
    ...
    {{"natural", "wood", "coniferous"}, {{"natural", "wood"}, {"leaf_type", "coniferous"}}},
    {{"natural", "wood", "coniferous"}, {{"natural", "wood"}, {"wood", "coniferous"}}},
    {{"natural", "wood", "deciduous"}, {{"natural", "wood"}, {"leaf_cycle", "deciduous"}}},
    {{"natural", "wood", "deciduous"}, {{"natural", "wood"}, {"leaf_type", "deciduous"}}},
    {{"natural", "wood", "deciduous"}, {{"natural", "wood"}, {"wood", "deciduous"}}},
    {{"natural", "wood", "mixed"}, {{"natural", "wood"}, {"leaf_cycle", "mixed"}}},
    {{"natural", "wood", "mixed"}, {{"natural", "wood"}, {"leaf_type", "mixed"}}},
    {{"natural", "wood", "mixed"}, {{"natural", "wood"}, {"wood", "mixed"}}},
