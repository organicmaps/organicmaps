...
void TestPlace::SetType(base::StringIL const & e) { m_type = classif().GetTypeByPath(e); }
...
uint32_t TestCity::GetCityType() { return classif().GetTypeByPath({"place", "city"}); }
...
void TestStreet::SetType(base::StringIL const & e) { m_highwayType = classif().GetTypeByPath(e); }
