...
{
public:
  static std::vector<std::string> GetCountryNames() { return {"Nepal"}; }
...
REGISTER_COUNTRY_SPECIFIER(NepalSpecifier);
...
PlaceLevel NepalSpecifier::GetSpecificCountryLevel(Region const & region) const
{
  ...
  switch (adminLevel)
  {
  case AdminLevel::Three: return PlaceLevel::Region;   // Province
