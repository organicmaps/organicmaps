...
public:
  ...
  explicit NamesExtractor(FeatureBuilderParams & params)
    : m_params(params)
  {}
...
{
public:
  explicit TagProcessor(OsmElement * elem)
    : m_element(elem)
  {}
...
void PreprocessElement(OsmElement * p, CalculateOriginFnT const & calcOrg)
{
  ...
  public:
    ...
    CountriesLoader()
      : m_provinceToState{"Japan", "South Korea", "Turkey"}
    {
                    ...
                    CalculateOriginFnT const & calcOrg)
{
  ...
  TagProcessor(p).ApplyRules<void(string &, string &)>({
    ...
    {"addr:place", "*", [&addr](string & k, string & v) { addr.Set(feature::AddressData::Type::Place, std::move(v)); }},
