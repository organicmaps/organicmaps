...
std::string Normalize(std::string_view lang) { return std::string{lang.substr(0, lang.find_first_of("-_ "))}; }

std::string GetCurrentNorm() { return Normalize(GetCurrentOrig()); }
...
std::string GetCurrentTwine() { return GetTwine(GetCurrentOrig()); }

std::string GetCurrentMapTwine() { return GetTwine(GetCurrentMapLanguage()); }
