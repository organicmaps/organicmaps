...
VulkanProgramPool::~VulkanProgramPool() { ProgramParams::Destroy(); }
...
uint32_t VulkanProgramPool::GetMaxUniformBuffers() const { return kMaxUniformBuffers; }

uint32_t VulkanProgramPool::GetMaxImageSamplers() const { return m_maxImageSamplers; }
}  // namespace vulkan
}  // namespace gpu
