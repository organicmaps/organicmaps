...
UNIT_TEST(CrossCountry_Schengen_Borders_Austria_to_Austria_through_Germany)
{
  integration::CalculateRouteAndTestRouteLength(
      integration::GetVehicleComponents(routing::VehicleType::Car),
...
{
  integration::CalculateRouteAndTestRouteLength(integration::GetVehicleComponents(routing::VehicleType::Car),
...
UNIT_TEST(CrossCountry_Russia_Belgorod_Oblast_to_Crimea)
{
  ...
  integration::CalculateRouteAndTestRouteLength(integration::GetVehicleComponents(routing::VehicleType::Car),
                                                mercator::FromLatLon(50.39589, 38.83377) /* startPoint */,
                                                {0.0, 0.0} /* startDirection */,
...
UNIT_TEST(CrossCountry_Lithuania_to_Poland)
{
  ...
  integration::CalculateRouteAndTestRouteLength(
      ...
      mercator::FromLatLon(54.27745, 22.33767) /* finalPoint */, 228'702 /* expectedRouteMeters */);
}
