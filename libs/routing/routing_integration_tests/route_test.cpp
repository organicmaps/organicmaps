...
UNIT_TEST(Norway_MotorVehicleBackward_No)
{
  ...
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Car), FromLatLon(59.919597, 10.759392), {0., 0.},
...
UNIT_TEST(Germany_MaxspeedConditional)
{
  ...
  auto const from = mercator::FromLatLon(50.853998, 12.837031);
  auto const to = mercator::FromLatLon(50.867373, 12.806966);
