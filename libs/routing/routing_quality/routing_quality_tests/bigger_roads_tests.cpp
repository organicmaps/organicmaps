...
{
  TEST(routing_quality::CheckCarRoute({55.84367, 37.44724} /* start */, {55.85489, 37.43784} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({38.80146, 26.97696} /* start */, {39.0837, 26.90977} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({42.71401, 18.30412} /* start */, {42.95101, 18.08966} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({50.10159, 14.43324} /* start */, {50.20976, 14.43361} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({60.16741, 24.94255} /* start */, {64.13182, 28.38784} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({35.39166, -97.55402} /* start */, {35.38452, -97.5742} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({32.45088, 51.76419} /* start */, {32.97067, 51.50399} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({50.91974, 5.33535} /* start */, {51.92532, 5.49066} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({57.77064, 11.88079} /* start */, {57.71231, 11.93157} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({38.48175, 27.12952} /* start */, {38.47558, 27.06765} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({50.37282, 18.75667} /* start */, {50.83499, 19.14612} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({56.009, 92.873} /* start */, {56.163, 101.611} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({51.65487, 39.21293} /* start */, {43.58547, 39.72311} /* finish */,
                                      {{{46.14169, 39.85306},
                                        {45.17069, 39.10869},
                                        {45.02157, 39.12510},
...
{
  TEST(routing_quality::CheckCarRoute({54.41616, 20.05675} /* start */, {52.18937, 20.94026} /* finish */,
                                      {{{54.24278, 19.66106},
                                        {54.13679, 19.45166},
                                        {54.06452, 19.62416},
                                        {53.69769, 19.98204},
...
{
  TEST(routing_quality::CheckCarRoute({55.92961, 36.04081} /* start */, {55.93567, 36.0533} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({56.62992, 25.77175} /* start */, {56.61453, 25.78400} /* finish */,
