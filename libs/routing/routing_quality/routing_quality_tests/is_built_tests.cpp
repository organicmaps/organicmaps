...
{
  // From Bilbau Airport.
  TEST(routing_quality::CheckCarRoute({43.3017, -2.9151} /* start */, {43.27637, -2.86924} /* finish */,
                                      {{{43.27759, -2.87367}}} /* reference track */),
       ());

  // To Bilbau Airport.
  TEST(routing_quality::CheckCarRoute({43.27651, -2.86918} /* start */, {43.2805, -2.87853} /* finish */,
...
UNIT_TEST(RoutingQuality_FairbanksAirport)
{
  ...
  TEST(routing_quality::CheckCarRoute({64.81398, -147.85897} /* start */, {64.85873, -147.69372} /* finish */,
                                      {{{64.85886, -147.70319}}} /* reference track */),
       ());

  // To Fairbanks International Airport.
  TEST(routing_quality::CheckCarRoute({64.85893, -147.69438} /* start */, {64.81398, -147.85897} /* finish */,
