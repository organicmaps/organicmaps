...
{
  TEST(routing_quality::CheckCarRoute({56.11155, 12.81101} /* start */, {55.59857, 12.3069} /* finish */,
...
//  TEST(routing_quality::CheckCarRoute({45.34123, 36.67679} /* start */, {45.36479, 36.62194} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({45.36479, 36.62194} /* start */, {45.34123, 36.67679} /* finish */,
                                      {{{45.3532, 36.64912}}} /* reference track */),
       ());
}
...
{
  TEST(routing_quality::CheckCarRoute({67.89425, 13.00747} /* start */, {67.28024, 14.37397} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({51.91347, 5.24265} /* start */, {51.98885, 5.20058} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({50.68323, 7.15683} /* start */, {50.58042, 7.32259} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({49.37098, 0.84813} /* start */, {49.47950, 0.80918} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({53.59885, 9.32285} /* start */, {53.93504, 9.48396} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({48.268548, 21.483862} /* start */, {48.24756, 21.54246} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({52.09319, 25.96368} /* start */, {52.02190, 25.98767} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({53.36914, 17.95644} /* start */, {53.46632, 18.01876} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({52.57264, 14.83948} /* start */, {52.74278, 14.95435} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({63.33900, 10.27831} /* start */, {63.33338, 10.22694} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({56.51167, 10.28726} /* start */, {56.57695, 10.11188} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({51.53923, 11.78523} /* start */, {51.62372, 11.86635} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({52.68467, 16.24031} /* start */, {52.74559, 16.27202} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({48.29162, 22.21412} /* start */, {48.27409, 22.46155} /* finish */,
