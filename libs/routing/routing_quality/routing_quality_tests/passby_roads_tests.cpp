...
UNIT_TEST(RoutingQuality_RussiaZelegonrad2Domodedovo)
{
  ...
  TEST(routing_quality::CheckCarRoute({55.98301, 37.21141} /* start */, {55.42081, 37.89361} /* finish */,
...
UNIT_TEST(RoutingQuality_BelarusKobrin)
{
  ...
  TEST(routing_quality::CheckCarRoute({52.18429, 24.20225} /* start */, {52.24404, 24.45842} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({53.24596, 28.93816} /* start */, {53.04386, 29.58098} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({60.08634, 30.10277} /* start */, {59.94584, 30.57703} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({53.75958, 28.005} /* start */, {54.03957, 26.83097} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({53.81784, 27.76789} /* start */, {53.94655, 27.36398} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({51.90356, -0.20133} /* start */, {51.23253, -0.33076} /* finish */,
...
//{
//  TEST(routing_quality::CheckCarRoute({51.29419, 31.25718} /* start */, {51.62678, 31.21787} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({52.17525, 22.19702} /* start */, {52.119802, 22.35855} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({47.18462, 20.04432} /* start */, {47.17919, 20.33486} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({32.46041, -99.93058} /* start */, {32.43085, -99.59475} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({44.81937, 10.2403} /* start */, {44.78228, 10.38824} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({45.99272, 14.59186} /* start */, {46.10318, 14.46829} /* finish */,
...
//{
//  TEST(routing_quality::CheckCarRoute({46.63612, 0.35762} /* start */, {46.49, 0.36787} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({47.03437, 0.04437} /* start */, {46.97887, 0.09692} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({47.22972, -0.30962} /* start */, {47.17023, -0.2185} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({50.88374, 4.2195} /* start */, {50.91494, 4.38122} /* finish */,
...
{
  TEST(routing_quality::CheckCarRoute({55.44681, 10.29} /* start */, {55.45877, 10.26456} /* finish */,
