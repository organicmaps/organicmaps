...
// Coniferous forest (landuse=forest|coniferous): the fir glyph only. Same analytic scatter, seam handling
// and constants as the mixed forest - see area_forest.fsh.glsl for the full commentary; here just the pine.
...
// Pine: two stacked triangle tiers + a trunk. +y is up.
