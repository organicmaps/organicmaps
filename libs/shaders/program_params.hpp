...
struct ALIGNMENT MapProgramParams
{
  ...
  BIND_PROGRAMS(MapProgramParams, Program::Area, Program::Area3d, Program::Area3dOutline, Program::AreaOutline,
                ...
                Program::DashedLine, Program::RainbowLine, Program::DashedRainbowLine, Program::TransparentArea,
                Program::HatchingArea, Program::Line, Program::MaskedTexturing, Program::MaskedTexturingBillboard,
