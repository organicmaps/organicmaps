...
public:
  ...
  static int8_t constexpr kSimplifiedChineseCode = 46;
  static int8_t constexpr kTraditionalChineseCode = 47;
  ...
  static auto constexpr kLocaleMapping = std::to_array<CategoriesHolder::Mapping>({
      {"en", kEnglishCode},
      {"en-AU", 2},
      {"en-GB", 3},
      {"en-US", 4},
