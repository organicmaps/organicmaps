...
std::pair<MwmId, MwmSet::RegResult> MwmSet::Register(LocalCountryFile const & localFile)
{
  std::pair<MwmId, MwmSet::RegResult> result;
...
std::pair<MwmId, MwmSet::RegResult> MwmSet::RegisterImpl(LocalCountryFile const & localFile, EventList & events)
{
...
MwmId MwmSet::GetMwmIdByCountryFile(CountryFile const & countryFile) const
{
  std::lock_guard<std::mutex> lock(m_lock);
