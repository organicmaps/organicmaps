...
bool MapObject::HasOnlineSchedule() const
{
  using namespace ftypes;
  return IsPublicTransportStopChecker::Instance()(m_types) ||
    IsRailwayStationChecker::Instance()(m_types) || IsSubwayStationChecker::Instance()(m_types);
}
