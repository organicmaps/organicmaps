...
UNIT_CLASS_TEST(ProcessorTest, USAddress_WState_Chicago)
{
  ...
  SetViewport(mercator::MetersToXY(41.8758005, -87.6189715, 100));
...
UNIT_CLASS_TEST(ProcessorTest, USAddresss_WState_NY)
{
  using namespace mercator;
  std::string const lang = "en";
  ...
  SetViewport(mercator::MetersToXY(40.7128, -74.006, 100));
