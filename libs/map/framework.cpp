...
std::string_view constexpr kAskedForRateUsTime = "kAskedLoyalUsersForStarsTime";
...
{
#ifdef DEBUG
  uint32_t constexpr kMinForegroundDuration = 10;
#else
  uint32_t constexpr kMinForegroundDuration = 60;
#endif
...
#ifdef DEBUG
  uint32_t constexpr kLastAskedForRateUsTimeout = 30;  // 30 seconds
#else
...
{
  settings::Set(kAskedForRateUsTime, base::SecondsSinceEpoch());
}
