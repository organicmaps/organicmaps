...
UNIT_TEST(Bookmarks_ModifiedTimestamp_BulkCategoryRecolor)
{
  ...
  bmManager.GetEditSession().SetCategoryBookmarksColor(catId, kml::PredefinedColor::Red);
  ...
  bmManager.GetEditSession().SetCategoryTracksColor(catId, kml::PredefinedColor::Red);
