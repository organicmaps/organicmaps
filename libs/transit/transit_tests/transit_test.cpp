...
{
  TransitHeader const bigHeader(kTransitVersion /* version */, 500 /* stopsOffset */, 1000 /* gatesOffset */,
...
UNIT_TEST(Transit_HeaderSerialization)
{
  ...
  {
    TransitHeader header(kTransitVersion /* version */, 500 /* stopsOffset */, 1000 /* gatesOffset */,
...
UNIT_TEST(Transit_TransitHeaderValidity)
{
  ...
  {
    TransitHeader const header(kTransitVersion /* version */, 40 /* stopsOffset */, 44 /* gatesOffset */,
                               48 /* edgesOffset */, 52 /* transfersOffset */, 56 /* linesOffset */,
                               60 /* shapesOffset */, 64 /* networksOffset */, 68 /* endOffset */);
    TEST(header.IsValid(), (header));
  }
  {
    TransitHeader const header(kTransitVersion /* version */, 44 /* stopsOffset */, 40 /* gatesOffset */,
                               48 /* edgesOffset */, 52 /* transfersOffset */, 56 /* linesOffset */,
                               60 /* shapesOffset */, 64 /* networksOffset */, 68 /* endOffset */);
    TEST(!header.IsValid(), (header));
  }
