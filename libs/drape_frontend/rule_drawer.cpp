  ...
  , m_deviceLang(deviceLang)
{
  ...
  m_style = GetStyleReader().GetCurrentStyle();
}
...
{
  ApplyLineFeatureGeometry applyGeom(m_context->GetTileKey(), insertShape, f, m_currentScaleGtoP, m_style);
