...
df::RainbowLineViewParams MakeRainbowParams(buffer_vector<dp::Color, 4> const & colors, float stripeWidth)
{
...
UNIT_TEST(RainbowLineGpuTest)
{
  ...
  fixture.Render("RainbowLine GPU", 400, 300, [](df::test_support::ShapeTestFixture & f)
  {
    // -- 2-color horizontal rainbow line --
    {
      ...
      f.AddShape(make_unique_dp<df::RainbowLineShape>(spline, params));
    }
