...
#include "platform/placement_sett.hpp"
...
public:
  ...
  virtual DepthLayer GetDepthLayer(settings::Placement) const { return GetDepthLayer(); }
  virtual drape_ptr<TitlesInfo> GetTitleDecl(settings::Placement) const { return GetTitleDecl(); }
