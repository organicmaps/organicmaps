...
TimeZone GetLocalTimeZone()
{
  ...
  std::time_t const localAsUtc = timegm(&local);
  std::time_t const utcAsUtc = timegm(&utc);
  ...
  std::time_t const janLocal = mktime(&jan);
  std::tm janUtc{};
  ...
  TimeZone localTz{
      ...
      .base_offset = static_cast<int16_t>(janOffset / 60),
