...
public:
  ...
  {
    if (self.IsDynamic())
      return self.m_dynamic.data();

    return &self.m_static[0];
  }
  //@}

  constexpr auto begin(this auto & self) { return self.data(); }
  constexpr auto cbegin(this auto const & self) { return self.data(); }
  constexpr auto end(this auto & self) { return self.data() + self.size(); }
  constexpr auto cend(this auto const & self) { return self.data() + self.size(); }
  //@}
