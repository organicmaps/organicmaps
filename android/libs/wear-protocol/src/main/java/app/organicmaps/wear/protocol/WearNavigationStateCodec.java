...
/**
 * Encodes/decodes {@link WearNavigationState} for the Wear Data Layer. JSON keeps the schema
 * explicit and evolvable; {@link #decode} rejects a mismatched protocol version so incompatible
 * peers degrade gracefully instead of misreading the bytes.
 *
