...
public class WearNavigationStateCodecTest
{
  ...
  @Test
  public void decodeIgnoresUnknownFieldWithinCurrentVersion()
  {
    final byte[] extended =
        ("{\"version\":" + WearNavigationData.VERSION + ",\"mode\":\"NAVIGATION\",\"unknown\":true}")
            .getBytes(StandardCharsets.UTF_8);
    assertEquals(WearNavigationMode.NAVIGATION, WearNavigationStateCodec.decode(extended).getMode());
  }
