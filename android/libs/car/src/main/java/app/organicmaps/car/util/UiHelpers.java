...
public final class UiHelpers
{
                                                 ...
                                                 @NonNull LocationHelper locationHelper)
  {
    ...
    final Action location = createLocationButton(context, locationHelper);
  ...
  public static MapController createMapController(@NonNull CarContext context, @NonNull Renderer surfaceRenderer,
                                                  @NonNull LocationHelper locationHelper)
  {
    return new MapController.Builder()
        .setMapActionStrip(createMapActionStrip(context, surfaceRenderer, locationHelper))
        .build();
  }
    ...
    return new Action.Builder()
        ...
        .setOnClickListener(() -> {
          ...
          if (mapScreen.getScreenManager().getTop() != mapScreen)
            return;
          final Screen settingsScreen = new SettingsScreen(context, mapScreen.getOrganicMapsContext(), surfaceRenderer);
  ...
  @NonNull
  private static Action createLocationButton(@NonNull CarContext context, @NonNull LocationHelper locationHelper)
  {
