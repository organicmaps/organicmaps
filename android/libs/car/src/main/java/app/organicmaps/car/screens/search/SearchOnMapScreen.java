...
public class SearchOnMapScreen extends BaseMapScreen implements SearchListener
{
  ...
  private Row createResultItem(@NonNull SearchResult result, int resultIndex)
  {
    ...
    else
    {
      ...
      builder.setOnClickListener(
          ()
              -> getScreenManager().push(new Builder(getCarContext(), getOrganicMapsContext(), getSurfaceRenderer())
  ...
  public void onResume(@NonNull LifecycleOwner owner)
  {
    ...
    final MapObject location = getLocationHelper().getMyPosition();
  ...
  public static final class Builder
  {
    ...
    public Builder(@NonNull CarContext carContext, @NonNull OrganicMaps organicMapsContext,
