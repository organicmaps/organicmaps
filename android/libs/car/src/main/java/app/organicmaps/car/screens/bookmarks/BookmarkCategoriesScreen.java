...
public class BookmarkCategoriesScreen extends BaseMapScreen
{
  ...
  public BookmarkCategoriesScreen(@NonNull CarContext carContext, @NonNull OrganicMaps organicMapsContext,
  ...
  private ListTemplate createBookmarkCategoriesListTemplate()
  {
    ...
    for (int i = 0; i < categoriesSize; ++i)
    {
      ...
      itemBuilder.setOnClickListener(
          ()
              -> getScreenManager().push(new BookmarksScreen(getCarContext(), getOrganicMapsContext(),
                                                             getSurfaceRenderer(), bookmarkCategory)));
