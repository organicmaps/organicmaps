...
public class BookmarksScreen extends BaseMapScreen
{
  ...
  public BookmarksScreen(@NonNull CarContext carContext, @NonNull OrganicMaps organicMapsContext,
  ...
  private Action createSortingAction()
  {
    ...
    builder.setOnClickListener(() -> {
      ...
      getScreenManager().pushForResult(
          new SortingScreen(getCarContext(), getOrganicMapsContext(), getSurfaceRenderer(), mBookmarkCategory),
