...
interface NavigationActionHandler {
     ...
     * If `query` is not null or empty and coordinates are provided, the destination is set to the place resolved
     * from the query with search biased to the coordinates.
     *
     * @param lat        destination latitude or NaN.
     * @param lon        destination longitude or NaN.
     ...
     * from the query with search biased to the coordinates.
     *
     * @param lat   stop latitude or NaN.
     * @param lon   stop longitude or NaN.
