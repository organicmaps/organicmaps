...
{
  public static void logTipsShownEvent(@NonNull TipsApi provider, @NonNull TipsAction action)
  {
    nativeTipsShown(provider.ordinal(), action.ordinal());
  }
  ...
  private static native void nativeTipsShown(int type, int event);
