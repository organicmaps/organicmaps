...
public final class BookmarkCategory implements Parcelable
{
  ...
  {
    nativeSetCategoryColorWithBookmarks(mId, colorIndex);
  }
  ...
  private static native void nativeSetCategoryColorWithBookmarks(long catId, @PredefinedColors.Color int colorIndex);
