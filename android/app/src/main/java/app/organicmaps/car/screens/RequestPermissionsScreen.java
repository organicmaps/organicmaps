...
{
  private static final String TAG = RequestPermissionsScreen.class.getSimpleName();
  ...
  private void sendPermissionsRequestNotification()
  {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU &&
        ContextCompat.checkSelfPermission(getCarContext(), POST_NOTIFICATIONS) != PERMISSION_GRANTED)
    {
