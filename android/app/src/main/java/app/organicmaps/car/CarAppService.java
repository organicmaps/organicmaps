...
public final class CarAppService extends androidx.car.app.CarAppService
{
  ...
  @NonNull @Override public Session onCreateSession(@Nullable SessionInfo sessionInfo)
  {
  ...
  @NonNull public static NotificationCompat.Extender getCarNotificationExtender(@NonNull CarContext context)
  {
