...
public final class DownloaderHelpers
{
  ...
  @SuppressWarnings("ConstantConditions") public static boolean isWorldMapsDownloadNeeded()
  {
  ...
  @NonNull static List<CountryItem> getCountryItemsFromIds(@Nullable final String[] countryIds)
  {
  ...
  @NonNull static String getCountryName(@NonNull CountryItem country)
  {
