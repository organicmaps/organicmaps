...
public class SearchOnMapScreen extends BaseMapScreen implements SearchListener
{
  ...
  @NonNull private final String mQuery;
  ...
  @NonNull private ListTemplate createResultsListTemplate()
  {
  ...
  @Override public void onResume(@NonNull LifecycleOwner owner)
  {
    ...
    SearchEngine.INSTANCE.searchInteractive(
      mQuery, mIsCategory, mLocale, System.nanoTime(), true /* isMapAndTable */, hasLocation, lat, lon);
  }
  ...
  public static final class Builder
  {
    ...
    @NonNull public SearchOnMapScreen build()
    {
      if (mQuery.isEmpty())
