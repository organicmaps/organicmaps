...
public class RequestPermissionsActivity extends BaseMwmFragmentActivity
{
  ...
  @Nullable private ActivityResultLauncher<String[]> mPermissionsRequest;

  @Override protected void onSafeCreate(@Nullable Bundle savedInstanceState)
  {
    super.onSafeCreate(savedInstanceState);
    setContentView(R.layout.activity_request_permissions);

    findViewById(R.id.btn_grant_permissions).setOnClickListener(unused -> openAppPermissionSettings());
    mPermissionsRequest = registerForActivityResult(
      new ActivityResultContracts.RequestMultiplePermissions(), (grantedPermissions) -> closeIfPermissionsGranted());
  ...
  @Override protected void onSafeDestroy()
  {
    super.onSafeDestroy();
