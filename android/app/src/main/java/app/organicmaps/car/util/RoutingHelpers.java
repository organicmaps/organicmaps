...
public final class RoutingHelpers
{
  ...
  @NonNull public static Distance createDistance(@NonNull final app.organicmaps.util.Distance distance)
  {
  ...
  @NonNull public static LaneDirection createLaneDirection(@NonNull LaneWay laneWay, boolean isRecommended)
  {
  ...
  @NonNull
  public static Maneuver createManeuver(
    @NonNull final CarContext context, @NonNull CarDirection carDirection, int roundaboutExitNum)
  {
