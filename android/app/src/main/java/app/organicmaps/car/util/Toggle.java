...
{
  @DrawableRes private static final int CHECKBOX_ICON = R.drawable.ic_checkbox;
  @DrawableRes private static final int CHECKBOX_CHECKED_ICON = R.drawable.ic_checkbox_checked;
  ...
  @RequiresCarApi(6)
  @NonNull
  private static androidx.car.app.model.Toggle createToggle(
    @NonNull final OnClickListener onClickListener, boolean checked)
  {
