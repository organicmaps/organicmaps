...
public class NavigationController implements TrafficManager.TrafficCallback, NavMenu.NavMenuListener
{
  ...
  private void updateVehicle(@NonNull RoutingInfo info)
  {
    ...
    // We don't want to show the next next turn arrow in case of going straight
    final boolean showNextNextTurn =
        info.nextCarDirection != CarDirection.None && info.nextCarDirection != CarDirection.GoStraight;
