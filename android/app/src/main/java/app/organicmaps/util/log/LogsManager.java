 ...
 */
@ThreadSafe public final class LogsManager
{
  ...
  @Nullable private Application mApplication;
  private boolean mIsFileLoggingEnabled = false;
  @Nullable private String mLogsFolder;
   ...
   */
  @Nullable synchronized String getEnabledLogsFolder()
  {
   ...
   */
  @Nullable private String ensureLogsFolder()
  {
  ...
  @Nullable private String createLogsFolder(@Nullable final File dir)
  {
    if (dir != null)
    {
   ...
   * NOTE: initFileLogging() must be called before.
   */
  @NonNull String getSystemInformation()
  {
    assertFileLoggingInit();
  ...
  // Called from JNI.
  @SuppressWarnings("unused") @NonNull @Keep public static String getMemoryInfo(@NonNull Context context)
  {
