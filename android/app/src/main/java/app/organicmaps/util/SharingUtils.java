...
public class SharingUtils
{
  ...
  {
    final Framework.ShareData data = Framework.nativeGetShareDataForMyPosition(loc.getLatitude(), loc.getLongitude());
  ...
  public static void shareMapObject(@NonNull Context context, @NonNull MapObject object)
  {
    ...
    final Framework.ShareData data = Framework.nativeGetShareData();
    shareText(context, subjectFor(context, object.isMyPosition(), data.mSubjectBasis), data);
  }

  public static void shareBookmark(@NonNull Context context, @NonNull BookmarkInfo bookmark)
  {
    final Framework.ShareData data = Framework.nativeGetShareDataForBookmark(bookmark.getBookmarkId());
    shareText(context, subjectFor(context, false, data.mSubjectBasis), data);
  }
