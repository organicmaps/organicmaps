...
/// The core broadcasts one file-preparation result to every registered listener. Being the only
/// listener, this singleton remembers the requester that started the in-flight share and delivers
/// the result to it alone, so several open screens don't pop up duplicate share sheets.
