...
public abstract class BaseBookmarkCategoryAdapter<V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V>
{
  ...
  @NonNull private List<BookmarkCategory> mItems;
  ...
  @NonNull protected Context requireContext()
  {
    return mContext;
  }

  @NonNull public List<BookmarkCategory> getBookmarkCategories()
  {
    return mItems;
  }
  ...
  @NonNull public BookmarkCategory getCategoryByPosition(int position)
  {
