...
public final class BookmarksImportDialog
{
                            ...
                            @NonNull OnCategorySelectedListener listener)
  {
    ...
    if (categoryIds.length == 1 && failedFileNames.length == 0)
    {
      ...
      Toast.makeText(activity.getApplicationContext(), R.string.load_kmz_successful_toast, Toast.LENGTH_LONG).show();
      return null;
    }
    ...
    Dialog dialog = new MaterialAlertDialogBuilder(activity, R.style.MwmTheme_AlertDialog)
