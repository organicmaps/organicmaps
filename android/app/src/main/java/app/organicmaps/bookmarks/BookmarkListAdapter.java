...
public class BookmarkListAdapter extends RecyclerView.Adapter<Holders.BaseBookmarkHolder>
{
  ...
  @NonNull private final DataSource<BookmarkCategory> mDataSource;
  @Nullable private List<Long> mSearchResults;
  @Nullable private List<SortedBlock> mSortedResults;

  @SuppressWarnings("NullableProblems") @NonNull private SectionsDataSource mSectionsDataSource;

  @Nullable private RecyclerClickListener mClickListener;
  @Nullable private RecyclerLongClickListener mLongClickListener;
  ...
  public static abstract class SectionsDataSource
  {
    ...
    @Nullable public abstract String getTitle(int sectionIndex, @NonNull Resources rs);
  ...
  private static class CategorySectionsDataSource extends SectionsDataSource
  {
    ...
    @Override public boolean isEditable(int sectionIndex)
    {
      return sectionIndex != mDescriptionSectionIndex;
    }

    @Override public boolean hasTitle(int sectionIndex)
    {
      return true;
    }

    @Nullable public String getTitle(int sectionIndex, @NonNull Resources rs)
    {
    ...
    @Override public int getItemsCount(int sectionIndex)
    {
      if (sectionIndex == mDescriptionSectionIndex)
        return 1;
      if (sectionIndex == mTracksSectionIndex)
    ...
    @Override public int getItemsType(int sectionIndex)
    {
      if (sectionIndex == mDescriptionSectionIndex)
        return TYPE_DESC;
      if (sectionIndex == mTracksSectionIndex)
    ...
    @Override public void onDelete(@NonNull SectionPosition pos)
    {
    ...
    @Override public long getBookmarkId(@NonNull SectionPosition pos)
    {
      return BookmarkManager.INSTANCE.getBookmarkIdByPosition(getCategory().getId(), pos.getItemIndex());
    }

    @Override public long getTrackId(@NonNull SectionPosition pos)
    {
  ...
  {
    @NonNull private final List<Long> mSearchResults;
  ...
  {
    @NonNull private final List<SortedBlock> mSortedBlocks;
    ...
    @NonNull private SortedBlock getSortedBlock(int sectionIndex)
    {
  ...
  @Override @NonNull public Holders.BaseBookmarkHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
  {
  ...
  @Override public void onBindViewHolder(@NonNull Holders.BaseBookmarkHolder holder, int position)
  {
