...
{
  @NonNull private final List<LayerBottomSheetItem> mItems;
  ...
  @NonNull @Override public LayerHolder onCreateViewHolder(ViewGroup parent, int viewType)
  {
  ...
  @Override public void onBindViewHolder(LayerHolder holder, int position)
  {
