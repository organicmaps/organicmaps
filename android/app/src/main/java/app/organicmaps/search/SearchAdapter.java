...
class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchDataViewHolder>
{
  ...
  @Nullable private SearchResult[] mResults;
  ...
  private static abstract class BaseResultViewHolder extends SearchDataViewHolder
  {
    ...
    @Override void bind(@NonNull SearchResult result, int order)
    {
      mResult = result;
      mOrder = order;
  ...
  private class SuggestViewHolder extends BaseResultViewHolder
  {
    ...
    @Override TextView getTitleView()
    {
      return (TextView) itemView;
    }

    @Override void processClick(SearchResult result, int order)
    {
  ...
  {
    @NonNull final View mFrame;
    @NonNull final TextView mName;
    @NonNull final TextView mOpen;
    @NonNull final TextView mDescription;
    @NonNull final TextView mRegion;
    @NonNull final TextView mDistance;

    @Override int getTintAttr()
    {
      return 0;
    }
  ...
  @NonNull @Override public SearchDataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
  {
  ...
  @Override public void onBindViewHolder(@NonNull SearchDataViewHolder holder, int position)
  {
