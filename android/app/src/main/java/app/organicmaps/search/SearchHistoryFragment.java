...
public class SearchHistoryFragment extends BaseMwmRecyclerFragment<SearchHistoryAdapter>
{
  ...
  @NonNull @Override protected SearchHistoryAdapter createAdapter()
  {
    ...
    final boolean showMyPosition =
      (RoutingController.get().isWaitingPoiPick() && LocationHelper.from(requireContext()).getMyPosition() != null);
    return new SearchHistoryAdapter(controller, showMyPosition);
  }

  @Override protected @LayoutRes int getLayoutRes()
  {
