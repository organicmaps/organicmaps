...
public class SpeedLimitView extends View
{
  ...
  public SpeedLimitView(Context context, @Nullable AttributeSet attrs)
  {
    ...
    final TypedArray data = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SpeedLimitView, 0, 0);
    try
    {
      ...
      if (isInEditMode())
      {
        ...
        mSpeedLimitStr = mSpeedLimit > 0 ? Integer.toString(mSpeedLimit) : null;
