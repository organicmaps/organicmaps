...
{
  @Nullable private NetworkPolicy.NetworkPolicyListener mListener;
  ...
  @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState)
  {
    return new StackedButtonsDialog.Builder(requireContext())
      ...
      .setCancelable(false)
      .setPositiveButton(
        R.string.mobile_data_option_always, (dialog, which) -> onDialogBtnClicked(NetworkPolicy.Type.ALWAYS, true))
