...
public class ElevationProfileViewRenderer implements PlacePageStateListener
{
  ...
  public void render(@Nullable Track track, @NonNull ElevationInfo elevationInfo, @NonNull TrackStatistics stats)
  {
    ...
    mAscent.setText(formatDistance((int) stats.getAscent()));
    mDescent.setText(formatDistance((int) stats.getDescent()));
    mMaxAltitude.setText(formatDistance(stats.getMaxElevation()));
    mMinAltitude.setText(formatDistance(stats.getMinElevation()));
  }
