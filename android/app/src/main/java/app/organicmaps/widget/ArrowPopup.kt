...
object ArrowPopup {
     ...
     *    and an arrow indicator is rendered. When `null`, no arrow is drawn — the popup is
     *    centered horizontally under [widthAnchor].
     */
    ...
    private fun ArrowPopupBackground.alignArrowTo(
        ...
        arrowCx = (tipScreenX - popupX).toFloat().coerceIn(minCx, maxCx)
    }
