...

{
  ...
  private void showRoutesPopup(@NonNull View anchor)
  {
    ...
    mRoutesPopup = ArrowPopup.show(requireContext(), anchor, items, ArrowPopup.RowStyle.PASTEL_BACKGROUND, position -> {
  ...
  private void showTrackCandidatesPopup(@NonNull View arrowAnchor, @NonNull List<TrackSelectionCandidate> candidates)
  {
    ...
    mTrackCandidatesPopup = ArrowPopup.show(requireContext(), mPreview, items, ArrowPopup.RowStyle.COLOR_ICON_LEFT,
                                            Framework::nativeSelectTrackCandidate, arrowAnchor);
