...
public class FeatureCategory implements Parcelable
{
  ...
  @NonNull private final String mLocalizedTypeName;
  ...
  @NonNull public String getLocalizedTypeName()
  {
  ...
  public static final Creator<FeatureCategory> CREATOR = new Creator<>() {
    @Override public FeatureCategory createFromParcel(Parcel source)
    {
      return new FeatureCategory(source);
    }

    @Override public FeatureCategory[] newArray(int size)
    {
