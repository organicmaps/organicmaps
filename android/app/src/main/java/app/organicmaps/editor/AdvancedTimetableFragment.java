...
public class AdvancedTimetableFragment extends BaseMwmFragment implements View.OnClickListener, TimetableProvider
{
  ...
  @Nullable private String mInitTimetables;
  @Nullable TimetableChangedListener mListener;
  ...
  private static void setTextChangedListener(
    @Nullable TextInputEditText input, @Nullable TimetableChangedListener listener)
  {
