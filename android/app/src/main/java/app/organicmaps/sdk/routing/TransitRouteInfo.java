 ...
 */
// Used by JNI.
@Keep @SuppressWarnings("unused") public final class TransitRouteInfo
{
  @NonNull private final String mTotalDistance;
  @NonNull private final String mTotalDistanceUnits;
  private final int mTotalTimeInSec;
  @NonNull private final String mTotalPedestrianDistance;
  @NonNull private final String mTotalPedestrianDistanceUnits;
  private final int mTotalPedestrianTimeInSec;
  @NonNull private final TransitStepInfo[] mSteps;

  private TransitRouteInfo(@NonNull String totalDistance, @NonNull String totalDistanceUnits, int totalTimeInSec,
    @NonNull String totalPedestrianDistance, @NonNull String totalPedestrianDistanceUnits, int totalPedestrianTimeInSec,
  ...
  @NonNull public String getTotalPedestrianDistance()
  {
  ...
  @NonNull public String getTotalPedestrianDistanceUnits()
  {
  ...
  @NonNull public List<TransitStepInfo> getTransitSteps()
  {
