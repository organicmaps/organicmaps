...
JNIEXPORT jstring JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetRoot(JNIEnv * env, jclass clazz)
{
  return jni::ToJavaString(env, GetStorage().GetRootId());
}

// static boolean nativeMoveFile(String oldFile, String newFile);
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeMoveFile(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeHasSpaceToDownloadAmount(JNIEnv * env,
                                                                                                     jclass clazz,
                                                                                                     jlong bytes)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeHasSpaceToDownloadCountry(JNIEnv * env,
                                                                                                      jclass clazz,
                                                                                                      jstring root)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeHasSpaceToUpdate(JNIEnv * env, jclass clazz,
                                                                                             jstring root)
{
...
JNIEXPORT jint JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetDownloadedCount(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetUpdateInfo(JNIEnv * env, jclass clazz,
                                                                                         jstring root)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeListItems(JNIEnv * env, jclass clazz,
                                                                                  jstring parent, jdouble lat,
                                                                                  jdouble lon, jboolean hasLocation,
                                                                                  jboolean myMapsMode, jobject result)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetAttributes(JNIEnv * env, jclass,
                                                                                      jobject item)
{
  auto const & ciBuilder = CountryItemBuilder::Instance(env);
...
JNIEXPORT jint JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetStatus(JNIEnv * env, jclass clazz,
                                                                                  jstring root)
{
...
JNIEXPORT jint JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetError(JNIEnv * env, jclass clazz,
                                                                                 jstring root)
{
  storage::NodeStatuses ns;
  GetStorage().GetNodeStatuses(jni::ToNativeString(env, root), ns);
...
JNIEXPORT jstring JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetName(JNIEnv * env, jclass clazz,
                                                                                   jstring root)
{
...
JNIEXPORT jstring JNICALL Java_app_organicmaps_downloader_MapManager_nativeFindCountry(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeIsDownloading(JNIEnv * env, jclass clazz)
{
  ...
  for (auto & key : g_batchedCallbackData)
  {
    ...
    for (TBatchedData const & dataItem : key.second)
    {
      ...
      static jclass batchDataClass =
        jni::GetGlobalClassRef(env, "app/organicmaps/downloader/MapManager$StorageCallbackData");
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeDownload(JNIEnv * env, jclass clazz,
                                                                                 jstring root)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeRetry(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeUpdate(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeCancel(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeDelete(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT jint JNICALL Java_app_organicmaps_downloader_MapManager_nativeSubscribe(JNIEnv * env, jclass clazz,
                                                                                  jobject listener)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeUnsubscribe(JNIEnv * env, jclass clazz,
                                                                                    jint slot)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeSubscribeOnCountryChanged(JNIEnv * env,
                                                                                                  jclass clazz,
                                                                                                  jobject listener)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeUnsubscribeOnCountryChanged(JNIEnv * env,
                                                                                                    jclass clazz)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeHasUnsavedEditorChanges(JNIEnv * env,
                                                                                                    jclass clazz,
                                                                                                    jstring root)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetPathTo(JNIEnv * env, jclass clazz,
...
JNIEXPORT jint JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetOverallProgress(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeIsAutoretryFailed(JNIEnv * env,
                                                                                              jclass clazz)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_MapManager_nativeIsDownloadOn3gEnabled(JNIEnv * env,
                                                                                                  jclass clazz)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_MapManager_nativeEnableDownloadOn3g(JNIEnv * env, jclass clazz)
{
  g_framework->EnableDownloadOn3g();
}

// static @Nullable String nativeGetSelectedCountry();
JNIEXPORT jstring JNICALL Java_app_organicmaps_downloader_MapManager_nativeGetSelectedCountry(JNIEnv * env,
                                                                                              jclass clazz)
{
