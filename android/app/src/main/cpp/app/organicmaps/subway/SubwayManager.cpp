...
JNIEXPORT void JNICALL Java_app_organicmaps_maplayer_subway_SubwayManager_nativeAddListener(JNIEnv * env, jclass clazz,
                                                                                            jobject listener)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_maplayer_subway_SubwayManager_nativeRemoveListener(JNIEnv * env,
                                                                                               jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
