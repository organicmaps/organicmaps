...
{
  static jclass const dateUtilsClass = jni::GetGlobalClassRef(env, "app/organicmaps/util/DateUtils");
...
extern "C"
{
JNIEXPORT void JNICALL Java_app_organicmaps_editor_OpeningHours_nativeInit(JNIEnv * env, jclass clazz)
{
  ...
  g_ctorTimespan =
    env->GetMethodID(g_clazzTimespan, "<init>",
                     "(Lapp/organicmaps/editor/data/HoursMinutes;Lapp/organicmaps/editor/data/HoursMinutes;)V");
  ...
  g_ctorTimetable = env->GetMethodID(
    g_clazzTimetable, "<init>", "(Lapp/organicmaps/editor/data/Timespan;[Lapp/organicmaps/editor/data/Timespan;Z[I)V");
  ...
  g_fidClosedTimespans =
    env->GetFieldID(g_clazzTimetable, "closedTimespans", "[Lapp/organicmaps/editor/data/Timespan;");
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_OpeningHours_nativeGetDefaultTimetables(JNIEnv * env,
                                                                                                   jclass clazz)
{
  TimeTableSet tts;
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_OpeningHours_nativeGetComplementTimetable(JNIEnv * env,
                                                                                                jclass clazz,
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_OpeningHours_nativeRemoveWorkingDay(
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_OpeningHours_nativeAddWorkingDay(JNIEnv * env, jclass clazz,
                                                                                            jobjectArray timetables,
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_OpeningHours_nativeSetIsFullday(JNIEnv * env, jclass clazz,
                                                                                      jobject jTimetable,
                                                                                      jboolean jIsFullday)
{
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_OpeningHours_nativeSetOpeningTime(JNIEnv * env, jclass clazz,
                                                                                        jobject jTimetable,
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_OpeningHours_nativeAddClosedSpan(JNIEnv * env, jclass clazz,
                                                                                       jobject jTimetable,
                                                                                       jobject jClosedSpan)
{
  TimeTable tt = NativeTimetable(env, jTimetable);
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_OpeningHours_nativeRemoveClosedSpan(JNIEnv * env, jclass clazz,
                                                                                          jobject jTimetable,
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_OpeningHours_nativeTimetablesFromString(JNIEnv * env,
                                                                                                   jclass clazz,
                                                                                                   jstring jSource)
{
  TimeTableSet tts;
...
JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_OpeningHours_nativeTimetablesToString(JNIEnv * env, jclass clazz,
                                                                                            jobjectArray jTts)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_OpeningHours_nativeIsTimetableStringValid(JNIEnv * env,
                                                                                                 jclass clazz,
                                                                                                 jstring jSource)
{
