...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeInit(JNIEnv * env, jclass)
{
  ...
  g_namesDataSourceConstructorID =
    jni::GetConstructorID(env, g_namesDataSourceClassID, "([Lapp/organicmaps/editor/data/LocalizedName;I)V");
}

JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetOpeningHours(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, g_editableMapObject.GetOpeningHours());
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetOpeningHours(JNIEnv * env, jclass, jstring value)
{
  g_editableMapObject.SetOpeningHours(jni::ToNativeString(env, value));
}

JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetMetadata(JNIEnv * env, jclass, jint id)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsMetadataValid(JNIEnv * env, jclass, jint id,
                                                                                    jstring value)
{
  auto const metaID = static_cast<osm::MapObject::MetadataID>(id);
  ASSERT_LESS(metaID, osm::MapObject::MetadataID::FMD_COUNT, ());
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetMetadata(JNIEnv * env, jclass, jint id,
                                                                            jstring value)
{
  auto const metaID = static_cast<osm::MapObject::MetadataID>(id);
  ASSERT_LESS(metaID, osm::MapObject::MetadataID::FMD_COUNT, ());
...
JNIEXPORT jint JNICALL Java_app_organicmaps_editor_Editor_nativeGetStars(JNIEnv * env, jclass)
{
  return g_editableMapObject.GetStars();
}

JNIEXPORT jint JNICALL Java_app_organicmaps_editor_Editor_nativeGetMaxEditableBuildingLevels(JNIEnv *, jclass)
{
  return osm::EditableMapObject::kMaximumLevelsEditableByUsers;
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeHasWifi(JNIEnv *, jclass)
{
  return g_editableMapObject.GetInternet() == feature::Internet::Wlan;
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetHasWifi(JNIEnv *, jclass, jboolean hasWifi)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeSaveEditedFeature(JNIEnv *, jclass)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeShouldShowEditPlace(JNIEnv *, jclass)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeShouldShowAddBusiness(JNIEnv *, jclass)
{
  ::Framework * frm = g_framework->NativeFramework();
  if (!frm->HasPlacePageInfo())
    return static_cast<jboolean>(false);
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeShouldShowAddPlace(JNIEnv *, jclass)
{
  ::Framework * frm = g_framework->NativeFramework();
  if (!frm->HasPlacePageInfo())
    return static_cast<jboolean>(false);
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeShouldEnableEditPlace(JNIEnv *, jclass)
{
  ::Framework * frm = g_framework->NativeFramework();
  if (!frm->HasPlacePageInfo())
    return static_cast<jboolean>(false);
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeShouldEnableAddPlace(JNIEnv *, jclass)
{
  ::Framework * frm = g_framework->NativeFramework();
  if (!frm->HasPlacePageInfo())
    return static_cast<jboolean>(false);
...
JNIEXPORT jintArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetEditableProperties(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsAddressEditable(JNIEnv * env, jclass clazz)
{
  return g_editableMapObject.IsAddressEditable();
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsNameEditable(JNIEnv * env, jclass clazz)
{
  return g_editableMapObject.IsNameEditable();
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsPointType(JNIEnv * env, jclass clazz)
{
  return g_editableMapObject.IsPointType();
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsBuilding(JNIEnv * env, jclass clazz)
{
  return g_editableMapObject.IsBuilding();
}

JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_Editor_nativeGetNamesDataSource(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetNames(JNIEnv * env, jclass, jobjectArray names)
{
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_Editor_nativeGetStreet(JNIEnv * env, jclass)
{
  return ToJavaStreet(env, g_editableMapObject.GetStreet());
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetStreet(JNIEnv * env, jclass, jobject street)
{
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetNearbyStreets(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetHouseNumber(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, g_editableMapObject.GetHouseNumber());
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetHouseNumber(JNIEnv * env, jclass,
                                                                               jstring houseNumber)
{
  g_editableMapObject.SetHouseNumber(jni::ToNativeString(env, houseNumber));
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeHasSomethingToUpload(JNIEnv * env, jclass clazz)
{
  return Editor::Instance().HaveMapEditsOrNotesToUpload();
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeUploadChanges(JNIEnv * env, jclass clazz, jstring token,
...
JNIEXPORT jlongArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetStats(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeClearLocalEdits(JNIEnv * env, jclass clazz)
{
  Editor::Instance().ClearAllLocalEdits();
}

JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeStartEdit(JNIEnv *, jclass)
{
  ::Framework * frm = g_framework->NativeFramework();
  if (!frm->HasPlacePageInfo())
  {
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeCreateMapObject(JNIEnv * env, jclass,
                                                                                jstring featureType)
{
  ::Framework * frm = g_framework->NativeFramework();
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeCreateNote(JNIEnv * env, jclass clazz, jstring text)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativePlaceDoesNotExist(JNIEnv * env, jclass clazz,
                                                                                  jstring comment)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeRollbackMapObject(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->RollBackChanges(g_editableMapObject.GetID());
}

JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetAllCreatableFeatureTypes(JNIEnv * env,
                                                                                                    jclass clazz,
                                                                                                    jstring jLang)
{
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeSearchCreatableFeatureTypes(JNIEnv * env,
                                                                                                    jclass clazz,
                                                                                                    jstring query,
                                                                                                    jstring jLang)
{
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetCuisines(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeGetSelectedCuisines(JNIEnv * env, jclass clazz)
{
  return jni::ToJavaStringArray(env, g_editableMapObject.GetCuisines());
}

JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeFilterCuisinesKeys(JNIEnv * env, jclass thiz,
                                                                                           jstring jSubstr)
{
...
JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_editor_Editor_nativeTranslateCuisines(JNIEnv * env, jclass clazz,
                                                                                          jobjectArray jKeys)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_editor_Editor_nativeSetSelectedCuisines(JNIEnv * env, jclass clazz,
                                                                                    jobjectArray jKeys)
{
  int const length = env->GetArrayLength(jKeys);
...
JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetFormattedCuisine(JNIEnv * env, jclass clazz)
{
  return jni::ToJavaString(env, g_editableMapObject.FormatCuisines());
}

JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetMwmName(JNIEnv * env, jclass clazz)
{
  return jni::ToJavaString(env, g_editableMapObject.GetID().GetMwmName());
}

JNIEXPORT jlong JNICALL Java_app_organicmaps_editor_Editor_nativeGetMwmVersion(JNIEnv * env, jclass clazz)
{
  return g_editableMapObject.GetID().GetMwmVersion();
}

// static boolean nativeIsHouseValid(String houseNumber);
JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsHouseValid(JNIEnv * env, jclass clazz,
                                                                                 jstring houseNumber)
{
  return osm::EditableMapObject::ValidateHouseNumber(jni::ToNativeString(env, houseNumber));
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsNameValid(JNIEnv * env, jclass clazz,
                                                                                jstring name)
{
  return osm::EditableMapObject::ValidateName(jni::ToNativeString(env, name));
}

JNIEXPORT jstring JNICALL Java_app_organicmaps_editor_Editor_nativeGetCategory(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jint JNICALL Java_app_organicmaps_editor_Editor_nativeGetMapObjectStatus(JNIEnv * env, jclass clazz)
{
  return static_cast<jint>(osm::Editor::Instance().GetFeatureStatus(g_editableMapObject.GetID()));
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_editor_Editor_nativeIsMapObjectUploaded(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_editor_Editor_nativeMakeLocalizedName(JNIEnv * env, jclass clazz,
