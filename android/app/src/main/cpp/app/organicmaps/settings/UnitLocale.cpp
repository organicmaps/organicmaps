...
extern "C"
{
JNIEXPORT void JNICALL Java_app_organicmaps_settings_UnitLocale_setCurrentUnits(JNIEnv * env, jobject thiz, jint units)
{
...
JNIEXPORT jint JNICALL Java_app_organicmaps_settings_UnitLocale_getCurrentUnits(JNIEnv * env, jobject thiz)
{
