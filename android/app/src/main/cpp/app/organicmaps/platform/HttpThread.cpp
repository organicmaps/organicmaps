...
void DeleteNativeHttpThread(HttpThread * request) { delete request; }

}  // namespace downloader

extern "C"
{
JNIEXPORT jboolean JNICALL Java_app_organicmaps_downloader_ChunkTask_nativeOnWrite(JNIEnv * env, jclass clazz,
...
JNIEXPORT void JNICALL Java_app_organicmaps_downloader_ChunkTask_nativeOnFinish(JNIEnv * env, jclass clazz,
