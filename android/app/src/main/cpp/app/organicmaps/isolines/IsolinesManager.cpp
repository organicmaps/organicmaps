...
JNIEXPORT void JNICALL Java_app_organicmaps_maplayer_isolines_IsolinesManager_nativeAddListener(JNIEnv * env,
                                                                                                jclass clazz,
                                                                                                jobject listener)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_maplayer_isolines_IsolinesManager_nativeRemoveListener(JNIEnv * env,
                                                                                                   jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
Java_app_organicmaps_maplayer_isolines_IsolinesManager_nativeShouldShowNotification(JNIEnv * env, jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
