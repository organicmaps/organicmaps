...
JNIEXPORT jint JNICALL Java_app_organicmaps_DownloadResourcesLegacyActivity_nativeGetBytesToDownload(JNIEnv * env,
                                                                                                     jclass clazz)
{
  // clear all
...
JNIEXPORT jint JNICALL Java_app_organicmaps_DownloadResourcesLegacyActivity_nativeStartNextFileDownload(
  JNIEnv * env, jclass clazz, jobject listener)
{
  ...
  downloader->EnsureMetaConfigReady(
    [&storage, ptr = jni::make_global_ref(listener)]()
    {
      auto const & curFile = g_filesToDownload.back();
...
JNIEXPORT void JNICALL Java_app_organicmaps_DownloadResourcesLegacyActivity_nativeCancelCurrentFile(JNIEnv * env,
                                                                                                    jclass clazz)
{
