...
JNIEXPORT void JNICALL Java_app_organicmaps_location_LocationState_nativeSwitchToNextMode(JNIEnv * env, jclass clazz)
{
  ASSERT(g_framework, ());
...
JNIEXPORT jint JNICALL Java_app_organicmaps_location_LocationState_nativeGetMode(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_location_LocationState_nativeSetListener(JNIEnv * env, jclass clazz,
                                                                                     jobject listener)
{
  ASSERT(g_framework, ());
...
JNIEXPORT void JNICALL Java_app_organicmaps_location_LocationState_nativeRemoveListener(JNIEnv * env, jclass clazz)
{
  ASSERT(g_framework, ());
  g_framework->SetMyPositionModeListener(location::TMyPositionModeChanged());
}

JNIEXPORT void JNICALL Java_app_organicmaps_location_LocationState_nativeOnLocationError(JNIEnv * env, jclass clazz,
                                                                                         int errorCode)
{
  ASSERT(g_framework, ());
...
JNIEXPORT void JNICALL Java_app_organicmaps_location_LocationState_nativeLocationUpdated(JNIEnv * env, jclass clazz,
