...
@RunWith(MockitoJUnitRunner.class) public class PlaceOpeningHoursAdapterTest
{
  ...
  @Test public void test_build_week_from_sunday()
  {
  ...
  @Test public void test_build_week_from_monday()
  {
  ...
  @Test public void test_build_week_from_saturday()
  {
  ...
  @Test public void test_build_week_from_friday()
  {
  ...
  @Test public void test_build_week_errors()
  {
  ...
  @Test public void test_single_closed_day_sunday() throws IllegalAccessException
  {
  ...
  @Test public void test_single_closed_day_monday() throws IllegalAccessException
  {
    // opening_hours = "Mo-Fr 09:00-18:00; Sa 12:00-14:00"
    Timetable[] timetables = new Timetable[2];
    timetables[0] = new Timetable(new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(18, 0, true)),
  ...
  @Test public void test_multiple_closed_day_monday() throws IllegalAccessException
  {
    // opening_hours = "Mo 09:00-18:00; We 10:00-18:00; Fr 11:00-18:00"
    Timetable[] timetables = new Timetable[3];
    timetables[0] = new Timetable(
      new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(18, 0, true)), new Timespan[0], false, new int[] {2});
  ...
  @Test public void test_multiple_closed_day_sunday() throws IllegalAccessException
  {
    // opening_hours = "Mo 09:00-18:00; We 10:00-18:00; Fr 11:00-18:00"
    Timetable[] timetables = new Timetable[3];
    timetables[0] = new Timetable(
  ...
  @Test public void test_multiple_closed_days_2_monday() throws IllegalAccessException
  {
    // opening_hours = "Mo 09:00-18:00; We 10:00-18:00; Fr 11:00-18:00"
  ...
  @Test public void test_multiple_closed_days_2_sunday() throws IllegalAccessException
  {
    // opening_hours = "Mo 09:00-18:00; We 10:00-18:00; Fr 11:00-18:00"
    Timetable[] timetables = new Timetable[1];
    timetables[0] = new Timetable(new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(18, 0, true)),
  ...
  @Test public void test_open_weekend_sunday() throws IllegalAccessException
  {
  ...
  @Test public void test_open_weekend_monday() throws IllegalAccessException
  {
    // opening_hours = "Sa-Su 11:00-24:00"
    Timetable[] timetables = new Timetable[1];
    timetables[0] = new Timetable(new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(24, 0, true)),
