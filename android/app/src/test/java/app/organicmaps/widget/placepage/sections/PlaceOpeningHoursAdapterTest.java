...
public class PlaceOpeningHoursAdapterTest
{
  ...
  public void test_format_open_shifts_no_break()
  {
    ...
    Timetable tt = new Timetable(new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(18, 0, true)),
                                 new Timespan[0], false, new int[] {2});
    assertEquals("09:00—18:00", PlaceOpeningHoursAdapter.formatOpenShifts(tt, "Noon", "Midnight"));
  }

  @Test
  public void test_format_open_shifts_one_break()
  {
    // "Mo 09:00-13:00,16:00-20:00" -> working 09:00-20:00 with one break -> two shifts.
    ...
    Timetable tt = new Timetable(new Timespan(new HoursMinutes(9, 0, true), new HoursMinutes(20, 0, true)), closed,
                                 false, new int[] {2});
    assertEquals("09:00—13:00\n16:00—20:00", PlaceOpeningHoursAdapter.formatOpenShifts(tt, "Noon", "Midnight"));
  }

  @Test
  public void test_format_open_shifts_two_breaks()
  {
    // "Mo 08:00-11:00,13:00-15:00,16:00-19:00" -> working 08:00-19:00 with two breaks -> three shifts.
    Timespan[] closed = {new Timespan(new HoursMinutes(11, 0, true), new HoursMinutes(13, 0, true)),
    ...
    Timetable tt = new Timetable(new Timespan(new HoursMinutes(8, 0, true), new HoursMinutes(19, 0, true)), closed,
                                 false, new int[] {2});
    assertEquals("08:00—11:00\n13:00—15:00\n16:00—19:00",
                 PlaceOpeningHoursAdapter.formatOpenShifts(tt, "Noon", "Midnight"));
  }

  @Test
  public void test_format_open_shifts_noon_midnight()
  {
    // Working 00:00-24:00 with a 12:00-13:00 break: the 00:00/12:00/24:00 boundaries get labels.
    Timespan[] closed = {new Timespan(new HoursMinutes(12, 0, true), new HoursMinutes(13, 0, true))};
    Timetable tt = new Timetable(new Timespan(new HoursMinutes(0, 0, true), new HoursMinutes(24, 0, true)), closed,
                                 false, new int[] {2});
    assertEquals("Midnight—Noon\n13:00—Midnight", PlaceOpeningHoursAdapter.formatOpenShifts(tt, "Noon", "Midnight"));
  }
}
