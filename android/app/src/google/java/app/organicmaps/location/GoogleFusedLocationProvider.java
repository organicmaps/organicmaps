...
class GoogleFusedLocationProvider extends BaseLocationProvider
{
  ...
  @NonNull private final FusedLocationProviderClient mFusedLocationClient;
  @NonNull private final SettingsClient mSettingsClient;
  ...
  private class GoogleLocationCallback extends LocationCallback
  {
    ...
    @Override public void onLocationAvailability(@NonNull LocationAvailability availability)
    {
