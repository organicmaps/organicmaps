...
UNIT_TEST(GetTtsStreetTextTest)
{
  ...
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu5), "Háromszáz méter után Forduljon jobbra az allére", ()); // Some speakers say allére but it's personal judgment
  ...
  Notification const notificationHu8(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("1"));
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu8), "Háromszáz méter után Forduljon jobbra az 1re", ());
  Notification const notificationHu8a(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("10"));
  ...
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu10), "Háromszáz méter után Forduljon jobbra a 7re", ()); // 7 is re
  ...
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu11), "Háromszáz méter után Forduljon jobbra a 71re", ()); // 70 is re and 1 is re
  ...
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu12), "Háromszáz méter után Forduljon jobbra az 50re", ()); // 5* is az and 50 is re
  ...
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu13), "Háromszáz méter után Forduljon jobbra az Ybl utcára", ()); // leading Y is a vowel
  Notification const notificationHu14(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("puszta "));
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu14), "Háromszáz méter után Forduljon jobbra a pusztára", ()); // trailing space shouldn't matter
  Notification const notificationHu15(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo(" puszta"));
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu15), "Háromszáz méter után Forduljon jobbra a pusztára", ()); // leading space shouldn't matter
  Notification const notificationHu16(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo(" "));
  // only spaces shouldn't matter, but it counts as an empty street name, thus not part of new TTS / Street Name / Hungarian logic, thus having a terminal period.
  TEST_EQUAL(getTtsText.GetTurnNotification(notificationHu16), "Háromszáz méter után Forduljon jobbra.", ());
  Notification const notificationHu17(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("puszta; "));
  // semicolon doesn't affect the suffix, but it does introduce punctuation that stops the a -> á replacement. Hopefully this is acceptable for now (odd case.)
