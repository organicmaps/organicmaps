...
UNIT_TEST(TestParseLanes)
{
  ...
  vector<SingleLaneInfo> const expected6 = {
      ...
      {LaneWay::through},
      {LaneWay::through},
      {LaneWay::through, LaneWay::right, LaneWay::sharp_right}};
...
UNIT_TEST(TestIsLaneWayConformedTurnDirection)
{
  ...
  TEST(IsLaneWayConformedTurnDirection(LaneWay::slight_left, CarDirection::TurnSlightLeft), ());
  TEST(IsLaneWayConformedTurnDirection(LaneWay::sharp_right, CarDirection::TurnSharpRight), ());
  ...
  TEST(!IsLaneWayConformedTurnDirection(LaneWay::slight_left, CarDirection::GoStraight), ());
  TEST(!IsLaneWayConformedTurnDirection(LaneWay::sharp_right, CarDirection::None), ());
...
UNIT_TEST(TestIsLaneWayConformedTurnDirectionApproximately)
{
  ...
  TEST(IsLaneWayConformedTurnDirectionApproximately(LaneWay::slight_left, CarDirection::GoStraight), ());
  TEST(IsLaneWayConformedTurnDirectionApproximately(LaneWay::slight_right, CarDirection::GoStraight), ());

  TEST(!IsLaneWayConformedTurnDirectionApproximately(LaneWay::sharp_left, CarDirection::UTurnLeft), ());
  TEST(!IsLaneWayConformedTurnDirectionApproximately(LaneWay::sharp_left, CarDirection::UTurnRight), ());
  TEST(!IsLaneWayConformedTurnDirectionApproximately(LaneWay::sharp_right, CarDirection::UTurnLeft), ());
  TEST(!IsLaneWayConformedTurnDirectionApproximately(LaneWay::sharp_right, CarDirection::UTurnRight), ());
  ...
  TEST(!IsLaneWayConformedTurnDirectionApproximately(LaneWay::slight_right,
...
UNIT_TEST(TestAddingActiveLaneInformation)
{
  ...
  turns[1].m_lanes.push_back({LaneWay::slight_left});
  turns[1].m_lanes.push_back({LaneWay::through});
  turns[1].m_lanes.push_back({LaneWay::none});

  turns[2].m_lanes.push_back({LaneWay::left, LaneWay::sharp_left});
