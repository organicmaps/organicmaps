...
namespace
{
  UNIT_TEST(StrangeCaseInAfrica)
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(19.20789, 30.50663), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.66218, 37.63253), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.75100, 37.61790), {0., 0.},
        MercatorBounds::FromLatLon(55.97310, 37.41460), 30470.);
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.97310, 37.41460), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.77399, 37.68468), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.85043, 37.43824), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(37.33409, -122.03458), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(54.7304, 55.9554), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.77787, 37.70405), {0., 0.},
  ...
  UNIT_TEST(RussiaFerryToCrimeaLoadCrossGeometryTest)
  {
    ...
    TRouteResult route = integration::CalculateRoute(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(45.34123, 36.67679), {0., 0.},
    ...
    // And backward case
    route = integration::CalculateRoute(integration::GetCarComponents(),
  ...
  UNIT_TEST(PriceIslandLoadCrossGeometryTest)
  {
    // Forward
    TRouteResult route = integration::CalculateRoute(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(46.16255, -63.81643), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(integration::GetCarComponents(),
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), {-1.2653036222483705, 61.691304855049886}, {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), {37.537596024929826, 67.536160359657288}, {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(-14.22061, -73.35969), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(55.75271, 37.62618), {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(51.09276, 1.11369), {0., 0.},
  ...
  UNIT_TEST(RussiaMoscowLenigradskiy39RepublicOfSouthAfricaCapeTownCenterRouteTest)
  {
    ...
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), {37.53754, 67.53622}, {0., 0.},
  ...
  {
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(27.15587, -13.23059), {0., 0.},
        MercatorBounds::FromLatLon(27.94049, -12.88800), 100864);
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(27.94049, -12.88800), {0., 0.},
  ...
  UNIT_TEST(AlbaniaToMontenegroCrossTest)
  {
    ...
    // Forward
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(42.01535, 19.40044), {0., 0.},
        MercatorBounds::FromLatLon(42.01201, 19.36286), 3674.);
    // And backward case
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(42.01201, 19.36286), {0., 0.},
  ...
  UNIT_TEST(CanadaBridgeCrossToEdwardIsland)
  {
    // Forward
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(46.13418, -63.84656), {0., 0.},
        MercatorBounds::FromLatLon(46.26739, -63.63907), 23000.);
    // And backward case
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(46.26739, -63.63907), {0., 0.},
  ...
  UNIT_TEST(RussiaFerryToCrimea)
  {
    // Forward
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(45.38053, 36.73226), {0., 0.},
        MercatorBounds::FromLatLon(45.36078, 36.60866), 13150.);
    // And backward case
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(45.36078, 36.60866), {0., 0.},
  ...
  UNIT_TEST(ParisCrossDestinationInForwardHeapCase)
  {
    // Forward
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(49.85015, 2.24296), {0., 0.},
        MercatorBounds::FromLatLon(48.85860, 2.34784), 126000.);
    // And backward case
    integration::CalculateRouteAndTestRouteLength(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(48.85860, 2.34784), {0., 0.},
  ...
  UNIT_TEST(RussiaSmolenskRussiaMoscowTimeTest)
  {
    TRouteResult const routeResult = integration::CalculateRoute(
        integration::GetCarComponents(), MercatorBounds::FromLatLon(54.7998, 32.05489), {0., 0.},
