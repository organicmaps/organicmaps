...
SpeedKMpH const & RoadGeometry::GetSpeed(bool forward) const { return forward ? m_forwardSpeed : m_backwardSpeed; }
...
SpeedInUnits GeometryLoader::GetSavedMaxspeed(uint32_t featureId, bool forward) { UNREACHABLE(); }
