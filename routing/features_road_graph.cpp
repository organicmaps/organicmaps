...
void FeaturesRoadGraphBase::CrossCountryVehicleModel::Clear() { m_cache.clear(); }
...
IRoadGraph::Mode FeaturesRoadGraphBase::GetMode() const { return m_mode; }
...
bool FeaturesRoadGraphBase::IsRoad(FeatureType & ft) const { return m_vehicleModel.IsRoad(ft); }

bool FeaturesRoadGraphBase::IsOneWay(FeatureType & ft) const { return m_vehicleModel.IsOneWay(ft); }
