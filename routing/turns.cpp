...
FeatureID const & SegmentRange::GetFeature() const { return m_featureId; }
...
bool IsLeftTurn(CarDirection t) { return (t >= CarDirection::TurnLeft && t <= CarDirection::TurnSlightLeft); }

bool IsRightTurn(CarDirection t) { return (t >= CarDirection::TurnRight && t <= CarDirection::TurnSlightRight); }

bool IsLeftOrRightTurn(CarDirection t) { return IsLeftTurn(t) || IsRightTurn(t); }
...
bool IsStayOnRoad(CarDirection t) { return (t == CarDirection::GoStraight || t == CarDirection::StayOnRoundAbout); }
...
string DebugPrint(CarDirection const turn) { return GetTurnString(turn); }
