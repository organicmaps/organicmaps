...
public:
  ...
  {
    return FindPathBidirectionalEx(params,
                                   [&result](RoutingResult<Vertex, Weight> && res)
                                   {
...
private:
  ...
  {
  public:
    PeriodicPollCancellable(base::Cancellable const & cancellable)
      : m_cancellable(cancellable)
    {}
