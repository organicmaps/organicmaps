...
{
  self.bm.PrepareFileForSharing(
    {groupId}, [self, completion](auto sharingResult)
...
- (void)shareTrack:(MWMTrackID)trackId
        ...
        completion:(SharingResultCompletionHandler)completion
{
  self.bm.PrepareTrackFileForSharing(
    trackId, [self, completion](auto sharingResult) { [self handleSharingResult:sharingResult completion:completion]; },
