                ...
                completion:(SearchInDownloaderCompletions)completion
{
  storage::DownloaderSearchParams params{
    query.UTF8String, locale.precomposedStringWithCompatibilityMapping.UTF8String,
    // m_onResults
...
+ (void)setTrackRecordingUpdateHandler:(TrackRecordingUpdatedHandler _Nullable)trackRecordingDidUpdate
{
  ...
  GetFramework().SetTrackRecordingUpdateHandler(
    [trackRecordingDidUpdate](TrackStatistics const & statistics)
    {
