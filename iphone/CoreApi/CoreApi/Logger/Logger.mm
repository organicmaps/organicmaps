...
NSString * const kLogFilePath =
  [[NSFileManager.defaultManager temporaryDirectory] URLByAppendingPathComponent:kLogFileName].path;
...
+ (NSURL *)getZippedLogFile:(NSString *)logFilePath
{
  NSString * zipFilePath =
    [[logFilePath stringByDeletingPathExtension] stringByAppendingPathExtension:kZipLogFileExtension];
