...
+ (NSString *)formattedOsmLinkForCoordinate:(CLLocationCoordinate2D)coordinate {
  auto const link = measurement_utils::FormatOsmLink(coordinate.latitude, coordinate.longitude, 14);
