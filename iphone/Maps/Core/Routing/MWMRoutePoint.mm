...
- (BOOL)isEqual:(id)object
{
  ...
  BOOL latLonEqual = (!self.latLonString && !other.latLonString) || [self.latLonString isEqualToString:other.latLonString];
  ...
  return titlesEqual && subtitlesEqual && latLonEqual && typeEqual && indexEqual && latitudeEqual && longitudeEqual && isMyPositionEqual;
}
