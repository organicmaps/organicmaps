...
extension CPMapTemplate.PanDirection {
  /// FrameworkHelper.moveMap shifts the camera by a fraction of the viewport using mixed axes:
  /// a positive horizontal moves it left, a positive vertical moves it down.
