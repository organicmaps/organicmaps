...
dp::GraphicsContext * MetalContextFactory::GetDrawContext() { return m_drawContext.get(); }

dp::GraphicsContext * MetalContextFactory::GetResourcesUploadContext() { return m_uploadContext.get(); }

void MetalContextFactory::SetPresentAvailable(bool available) { m_drawContext->SetPresentAvailable(available); }
