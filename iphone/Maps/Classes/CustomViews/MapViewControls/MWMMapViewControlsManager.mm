...
- (instancetype)initWithParentController:(MapViewController *)controller
{
  ...
  [TrackRecordingManager.shared addObserver:self
          recordingIsActiveDidChangeHandler:^(TrackRecordingState state, TrackInfo * trackInfo) {
...
- (UIStatusBarStyle)preferredStatusBarStyle
{
  ...
  BOOL const isSomethingUnderStatusBar =
    isNavigationUnderStatusBar || isDirectionViewUnderStatusBar || isMenuViewUnderStatusBar || isAddPlaceUnderStatusBar;
...
- (void)setTrackRecordingButtonHidden:(BOOL)trackRecordingButtonHidden
{
  ...
  {
    [self.trackRecordingButton closeWithCompletion:^{ [MWMMapWidgetsHelper updateLayoutForAvailableArea]; }];
