...
final class TTSSettingsPreviewCell: MWMTableViewCell {
  ...
  private func setupCell() {
    ...
    NSLayoutConstraint.activate([
      ...
      // Long voice names must wrap without squeezing the language into a few characters.
      detailLabel.widthAnchor.constraint(lessThanOrEqualTo: titleLabel.widthAnchor),
