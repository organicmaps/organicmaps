...
struct CamerasCellStrategy : BaseCellStategy
{
                              ...
                              MWMTTSSettingsViewController * controller) override
  {
    ...
    auto cell = static_cast<SettingsTableViewSelectableCell *>([tableView dequeueReusableCellWithCellClass:cls
                                                                                                 indexPath:indexPath]);
    NSString * title = nil;
    switch (static_cast<routing::SpeedCameraManagerMode>(indexPath.row))
    {
    case routing::SpeedCameraManagerMode::Auto: title = L(@"pref_tts_speedcams_auto"); break;
    case routing::SpeedCameraManagerMode::Always: title = L(@"pref_tts_speedcams_always"); break;
    case routing::SpeedCameraManagerMode::Never: title = L(@"pref_tts_speedcams_never"); break;
    case routing::SpeedCameraManagerMode::MaxValue: CHECK(false, ()); return nil;
    }
  ...
  size_t NumberOfRows(MWMTTSSettingsViewController * /* controller */) const override
  {
    return base::Underlying(routing::SpeedCameraManagerMode::MaxValue);
  }
                  ...
                  MWMTTSSettingsViewController * /* controller */) override
  {
    ...
    auto const mode = static_cast<routing::SpeedCameraManagerMode>(indexPath.row);
    CHECK_NOT_EQUAL(mode, routing::SpeedCameraManagerMode::MaxValue, ());
    scm.SetMode(mode);
    cell.accessoryType = UITableViewCellAccessoryCheckmark;
    m_selectedCell = cell;
  }
