...
{
  base::EraseIf(newAdditionalLanguages,
                [&names](NSInteger x)
                {
...
- (void)fillCell:(UITableViewCell * _Nonnull)cell atIndexPath:(NSIndexPath * _Nonnull)indexPath
{
  ...
  case MetadataID::FMD_BUILDING_LEVELS:
  {
    ...
    NSString * errorMessage = [NSString
      stringWithFormat:L(@"error_enter_correct_storey_number"), osm::EditableMapObject::kMaximumLevelsEditableByUsers];
    [self configTextViewCell:cell
                      cellID:cellID
                        icon:nil
