...
class BottomMenuPresenter: NSObject {
  ...
  private let trackRecorder: TrackRecordingObservation = TrackRecordingManager.shared
    ...
    case .items:
      ...
      case .addPlace:
        ...
        cell.configure(imageName: "ic_add_place",
                       ...
                       enabled: enabled)
      case .recordTrack:
        trackRecorder.addObserver(cell, trackRecordingStateDidChange: { cell.setState($0) })
        return cell
      case .downloadMaps:
