...
- If you get "not enough memory" errors during builds, you may disable
  ...
  The default is `CMAKE_UNITY_BUILD_BATCH_SIZE=10`, which should be safe for most systems with at least 16GB RAM and some swap. You may want to adjust it to your needs. \
  Note that these changes may significantly impact the build time. \
  Be careful though it might even hang your system if you rise the value too high!
