...
See [Class Constructor Methods](https://github.com/organicmaps/organicmaps/blob/master/docs/OBJC_STYLE.md#class-constructor-methods) for link to article on instancetype.
