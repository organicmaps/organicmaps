...
struct SpeedKMpH
{
  ...
  constexpr SpeedKMpH(double weight) noexcept
    : m_weight(weight)
    , m_eta(weight)
  {}
  constexpr SpeedKMpH(double weight, double eta) noexcept
    : m_weight(weight)
    , m_eta(eta)
  {}
...
struct SpeedFactor
{
  ...
  constexpr SpeedFactor(double factor) noexcept
    : m_weight(factor)
    , m_eta(factor)
  {}
  constexpr SpeedFactor(double weight, double eta) noexcept
    : m_weight(weight)
    , m_eta(eta)
  {}
