...
bool SpeedInUnits::IsNumeric() const { return routing::IsNumeric(m_speed); }

MaxspeedType SpeedInUnits::GetSpeedKmPH() const { return static_cast<MaxspeedType>(ToSpeedKmPH(m_speed, m_units)); }
...
MaxspeedConverter const & GetMaxspeedConverter() { return MaxspeedConverter::Instance(); }
