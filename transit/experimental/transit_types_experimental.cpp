...
// IdBundle ----------------------------------------------------------------------------------------
IdBundle::IdBundle(bool serializeFeatureIdOnly)
...
// Network -----------------------------------------------------------------------------------------
Network::Network(TransitId id, std::string const & title)
  : m_id(id)
  , m_title(title)
{}

Network::Network(TransitId id)
  : m_id(id)
  , m_title{}
{}
...
// Stop --------------------------------------------------------------------------------------------
Stop::Stop()
  : m_ids(true /* serializeFeatureIdOnly */)
{}
...
void Stop::SetBestPedestrianSegments(std::vector<SingleMwmSegment> const & seg) { m_bestPedestrianSegments = seg; }

std::vector<SingleMwmSegment> const & Stop::GetBestPedestrianSegments() const { return m_bestPedestrianSegments; }

// Gate --------------------------------------------------------------------------------------------
Gate::Gate()
  : m_ids(false /* serializeFeatureIdOnly */)
{}
...
void Gate::SetBestPedestrianSegments(std::vector<SingleMwmSegment> const & seg) { m_bestPedestrianSegments = seg; }
...
std::vector<SingleMwmSegment> const & Gate::GetBestPedestrianSegments() const { return m_bestPedestrianSegments; }
