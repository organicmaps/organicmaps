...
public:
  ...
  Stop()
    : m_featureIdentifiers(true /* serializeFeatureIdOnly */) {};
...
public:
  Gate()
    : m_featureIdentifiers(false /* serializeFeatureIdOnly */) {};
...
public:
  ShapeId() = default;
  ShapeId(StopId stop1Id, StopId stop2Id)
    : m_stop1Id(stop1Id)
    , m_stop2Id(stop2Id)
  {}
...
public:
  ...
  explicit StopIdRanges(Ranges const & ids)
    : m_ids(ids)
  {}
