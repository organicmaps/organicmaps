...
int GetScaleLevel(double ratio) { return base::SignedRound(GetScaleLevelD(ratio)); }

int GetScaleLevel(m2::RectD const & r) { return base::SignedRound(GetScaleLevelD(r)); }
...
double GetEpsilonForLevel(int level) { return GetEpsilonImpl(level, 7); }
