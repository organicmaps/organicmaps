...
DataHeader::DataHeader(FilesContainerR const & cont) { Load(cont); }
...
m2::RectD DataHeader::GetBounds() const { return Int64ToRectObsolete(m_bounds, m_codingParams.GetCoordBits()); }

void DataHeader::SetBounds(m2::RectD const & r) { m_bounds = RectToInt64Obsolete(r, m_codingParams.GetCoordBits()); }
...
void DataHeader::Load(FilesContainerR const & cont) { Load(cont.GetReader(HEADER_FILE_TAG)); }
