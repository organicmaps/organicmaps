...
namespace osm
{
std::list<JournalEntry> const & EditJournal::GetJournal() const { return m_journal; }
...
void EditJournal::AddJournalEntry(JournalEntry entry) { m_journal.push_back(std::move(entry)); }
...
std::list<JournalEntry> const & EditJournal::GetJournalHistory() const { return m_journalHistory; }

void EditJournal::AddJournalHistoryEntry(JournalEntry entry) { m_journalHistory.push_back(std::move(entry)); }
