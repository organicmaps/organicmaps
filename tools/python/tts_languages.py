...
// This file is autogenerated while exporting sounds.txt.
// It contains the list of languages which can be used by TTS.
// It shall be included to Android(jni) and iOS part to get the TTS languages list.
...
namespace sound
{{
std::array<std::string, {lang_list_size}> const ttsLanguageList =
{{{{
{lang_list}
}}}};
}}  // namespace sound
