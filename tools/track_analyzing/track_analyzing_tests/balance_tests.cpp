...
UNIT_TEST(FillTableTest)
{
  ...
  MwmToDataPoints const expectedMatchedDataPoints = {
      {"New Zealand", 2 /* data points */},
...
{
  MwmToDataPoints const map1 = {
      {"Russia_Moscow", 5 /* data points */},
      {   "San Marino", 7 /* data points */}
  };
  MwmToDataPoints map2 = {
      {"Russia_Moscow",  7 /* data points*/},
...
UNIT_TEST(RemoveKeysSmallValueTest)
{
  ...
  MwmToDataPoints expectedCheckedMap = {
      {"San Marino", 5 /* data points */}
  };
  MwmToDataPoints expectedAdditionalMap = {
      {"San Marino", 9 /* data points */}
  };
...
UNIT_TEST(BalancedDataPointNumberTheSameTest)
{
...

  {
    ...
    MwmToDataPoints expectedBalancedDataPointNumber = {
        {"Russia_Moscow", 10 /* data points */}
    };
...
UNIT_TEST(BalancedDataPointNumberTest)
{
  MwmToDataPoints distribution = {
      {"Russia_Moscow", 6000 /* data points */},
      {   "San Marino", 3000 /* data points */},
      {     "Slovakia", 1000 /* data points */}
  };
  MwmToDataPoints matchedDataPoints = {
      {"Russia_Moscow", 500 /* data points */},
...
{
  MwmToDataPoints distribution = {
      {"Russia_Moscow", 6'000'000'000'000 /* data points */},
      {   "San Marino", 3'000'000'000'000 /* data points */},
      {     "Slovakia", 1'000'000'000'000 /* data points */}
  };
  MwmToDataPoints matchedDataPoints = {
      {"Russia_Moscow", 500'000'000'000 /* data points */},
  ...
  };
  {
    ...
    MwmToDataPoints expectedBalancedDataPointNumber = {
        {"Russia_Moscow", 60'000'000'000 /* data points */},
...
UNIT_TEST(FilterTableTest)
{
  ...
  {
    auto table = csvTable;
    MwmToDataPoints const balancedDataPointNumbers = {
        {"New Zealand", 2 /* data points */},
        {     "Poland", 1 /* data points */}
    };
