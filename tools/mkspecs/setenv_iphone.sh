...
C_AND_CXX_FLAGS="-arch armv6 -fmessage-length=0 -pipe -fpascal-strings -Wall \
  -fvisibility=hidden -mthumb -miphoneos-version-min=$IOS_VERSION -gdwarf-2 \
...
LIBTOOL_FLAGS="-arch_only armv6 -syslibroot $SDK_ROOT"
