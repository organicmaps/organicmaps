...
bool BindingDecl::operator!=(BindingDecl const & other) const { return !operator==(other); }
...
uint8_t BindingInfo::GetCount() const { return static_cast<uint8_t>((m_info & 0xFF00) >> 8); }

uint8_t BindingInfo::GetID() const { return static_cast<uint8_t>(m_info & 0xFF); }
...
bool BindingInfo::IsDynamic() const { return GetID() > 0; }
...
bool BindingInfo::operator!=(BindingInfo const & other) const { return !operator==(other); }
