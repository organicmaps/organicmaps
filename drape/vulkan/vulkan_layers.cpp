...
uint32_t Layers::GetInstanceExtensionsCount() const { return static_cast<uint32_t>(m_instanceExtensions.size()); }

char const * const * Layers::GetInstanceExtensions() const { return m_instanceExtensions.data(); }
...
uint32_t Layers::GetDeviceExtensionsCount() const { return static_cast<uint32_t>(m_deviceExtensions.size()); }

char const * const * Layers::GetDeviceExtensions() const { return m_deviceExtensions.data(); }

bool Layers::IsValidationFeaturesEnabled() const { return m_validationFeaturesEnabled; }
}  // namespace vulkan
}  // namespace dp
