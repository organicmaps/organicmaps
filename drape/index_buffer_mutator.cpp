...
namespace dp
{
IndexBufferMutator::IndexBufferMutator(uint32_t baseSize) { m_buffer.Resize(baseSize); }
...
void const * IndexBufferMutator::GetIndexes() const { return m_buffer.GetRawConst(); }

uint32_t IndexBufferMutator::GetIndexCount() const { return m_activeSize; }

uint32_t IndexBufferMutator::GetCapacity() const { return m_buffer.Size(); }
}  // namespace dp
