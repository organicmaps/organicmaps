...
void GLFunctions::Init(dp::ApiVersion apiVersion) { MOCK_CALL(Init(apiVersion)); }

void GLFunctions::glFlush() {}

void GLFunctions::glFinish() {}

uint32_t GLFunctions::glGenVertexArray() { return MOCK_CALL(glGenVertexArray()); }

void GLFunctions::glBindVertexArray(uint32_t vao) { MOCK_CALL(glBindVertexArray(vao)); }

void GLFunctions::glDeleteVertexArray(uint32_t vao) { MOCK_CALL(glDeleteVertexArray(vao)); }

uint32_t GLFunctions::glGenBuffer() { return MOCK_CALL(glGenBuffer()); }

void GLFunctions::glBindBuffer(uint32_t vbo, glConst target) { MOCK_CALL(glBindBuffer(vbo, target)); }

void GLFunctions::glDeleteBuffer(uint32_t vbo) { MOCK_CALL(glDeleteBuffer(vbo)); }
...
uint32_t GLFunctions::glCreateShader(glConst type) { return MOCK_CALL(glCreateShader(type)); }
...
void GLFunctions::glDeleteShader(uint32_t shaderID) { MOCK_CALL(glDeleteShader(shaderID)); }

uint32_t GLFunctions::glCreateProgram() { return MOCK_CALL(glCreateProgram()); }
...
void GLFunctions::glDeleteProgram(uint32_t programID) { MOCK_CALL(glDeleteProgram(programID)); }

void GLFunctions::glUseProgram(uint32_t programID) { MOCK_CALL(glUseProgram(programID)); }
...
void GLFunctions::glUniformValuei(int8_t location, int32_t v) { MOCK_CALL(glUniformValuei(location, v)); }
...
void GLFunctions::glUniformValuef(int8_t location, float v) { MOCK_CALL(glUniformValuef(location, v)); }

void GLFunctions::glUniformValuef(int8_t location, float v1, float v2) { MOCK_CALL(glUniformValuef(location, v1, v2)); }
...
uint32_t GLFunctions::glGetCurrentProgram() { return MOCK_CALL(glGetCurrentProgram()); }

bool GLFunctions::glHasExtension(std::string const & extName) { return MOCK_CALL(glHasExtension(extName)); }
...
void GLFunctions::glActiveTexture(glConst texBlock) { MOCK_CALL(glActiveTexture(texBlock)); }
...
void GLFunctions::glDeleteTexture(uint32_t id) { MOCK_CALL(glDeleteTexture(id)); }

void GLFunctions::glBindTexture(uint32_t textureID) { MOCK_CALL(glBindTexture(textureID)); }
...
void GLFunctions::glTexParameter(glConst param, glConst value) { MOCK_CALL(glTexParameter(param, value)); }

int32_t GLFunctions::glGetInteger(glConst pname) { return MOCK_CALL(glGetInteger(pname)); }

std::string GLFunctions::glGetString(glConst pname) { return MOCK_CALL(glGetString(pname)); }

int32_t GLFunctions::glGetMaxLineWidth() { return MOCK_CALL(glGetMaxLineWidth()); }

void GLFunctions::glLineWidth(uint32_t value) { return MOCK_CALL(glLineWidth(value)); }
...
void GLFunctions::glScissor(uint32_t x, uint32_t y, uint32_t w, uint32_t h) { return MOCK_CALL(glScissor(x, y, w, h)); }

void GLFunctions::glGenFramebuffer(uint32_t * fbo) { return MOCK_CALL(glGenFramebuffer(fbo)); }

void GLFunctions::glBindFramebuffer(uint32_t fbo) { return MOCK_CALL(glBindFramebuffer(fbo)); }

void GLFunctions::glDeleteFramebuffer(uint32_t * fbo) { return MOCK_CALL(glDeleteFramebuffer(fbo)); }
...
uint32_t GLFunctions::glCheckFramebufferStatus() { return MOCK_CALL(glCheckFramebufferStatus()); }
...
void GLFunctions::glCullFace(glConst face) { MOCK_CALL(glCullFace(face)); }

void GLFunctions::glFrontFace(glConst mode) { MOCK_CALL(glFrontFace(mode)); }

void GLFunctions::glDepthMask(bool needWriteToDepthBuffer) { MOCK_CALL(glDepthMask(needWriteToDepthBuffer)); }

void GLFunctions::glClear(uint32_t clearBits) { MOCK_CALL(glClear(clearBits)); }

void GLFunctions::glClearColor(float r, float g, float b, float a) { MOCK_CALL(glClearColor(r, g, b, a)); }

void GLFunctions::glClearDepthValue(double depth) { MOCK_CALL(glClearDepthValue(depth)); }
