...
{
  static_assert(sizeof(Area3dVertex) ==
                  (sizeof(Area3dVertex::TPosition) + sizeof(Area3dVertex::TNormal3d) + sizeof(Area3dVertex::TTexCoord)),
                "");
...
{
  static_assert(
    sizeof(SolidTexturingVertex) == (sizeof(SolidTexturingVertex::TPosition3d) + sizeof(SolidTexturingVertex::TNormal) +
...
dp::BindingInfo const & AreaVertex::GetBindingInfo() { return GetBinding(Area); }
...
dp::BindingInfo const & Area3dVertex::GetBindingInfo() { return GetBinding(Area3d); }
...
dp::BindingInfo const & HatchingAreaVertex::GetBindingInfo() { return GetBinding(HatchingArea); }
...
dp::BindingInfo const & SolidTexturingVertex::GetBindingInfo() { return GetBinding(SolidTexturing); }
...
dp::BindingInfo const & MaskedTexturingVertex::GetBindingInfo() { return GetBinding(MaskedTexturing); }
...
dp::BindingInfo const & TextOutlinedStaticVertex::GetBindingInfo() { return GetBinding(TextOutlinedStatic); }
...
dp::BindingInfo const & TextDynamicVertex::GetBindingInfo() { return GetBinding(TextDynamic); }

uint32_t TextDynamicVertex::GetDynamicStreamID() { return 0x7F; }
...
dp::BindingInfo const & LineVertex::GetBindingInfo() { return GetBinding(Line); }
...
dp::BindingInfo const & DashedLineVertex::GetBindingInfo() { return GetBinding(DashedLine); }
...
dp::BindingInfo const & RouteVertex::GetBindingInfo() { return GetBinding(Route); }
...
dp::BindingInfo const & RouteMarkerVertex::GetBindingInfo() { return GetBinding(RouteMarker); }
...
dp::BindingInfo const & TextStaticVertex::GetBindingInfo() { return GetBinding(TextStatic); }
...
dp::BindingInfo const & ColoredSymbolVertex::GetBindingInfo() { return GetBinding(ColoredSymbol); }
}  // namespace gpu
