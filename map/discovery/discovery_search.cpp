...
std::unique_ptr<FeatureType> MakeFeatureTypeWithCachedGuard(
    DataSource const & dataSource, MwmSet::MwmId & mwmId,
    std::unique_ptr<FeaturesLoaderGuard> & guard, FeatureID const & id)
{
  if (mwmId != id.m_mwmId)
  {
