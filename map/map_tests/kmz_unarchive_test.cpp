...
UNIT_TEST(Open_KMZ_Test)
{
  ...
  cat.LoadFromKML(new FileReader(KMLFILE));
...

  {
    ...
    TEST_ALMOST_EQUAL(bm->GetOrg().y, 21.34256685860084, ("KML wrong org y!"));
  ...
  }
  {
    ...
    TEST_ALMOST_EQUAL(bm->GetOrg().y, 21.12480639056074, ("KML wrong org y!"));
    TEST_EQUAL(bm->GetScale(), -1, ("KML wrong scale!"));
  }
}
