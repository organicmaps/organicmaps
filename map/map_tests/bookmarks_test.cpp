...
KmlFileType GetActiveKmlFileType() { return KmlFileType::Text; }
...
Bookmark const * GetBookmarkPxPoint(Framework & fm, m2::PointD const & pt) { return GetBookmark(fm, fm.PtoG(pt)); }
...
UNIT_CLASS_TEST(Runner, TrackParsingTest_1)
{
  ...
  array<dp::Color, 4> constexpr col = {
    {dp::Color(230, 0, 0, 255), dp::Color(171, 230, 0, 255), dp::Color(0, 230, 117, 255), dp::Color(0, 59, 230, 255)}};
...
UNIT_CLASS_TEST(Runner, Bookmarks_Listeners)
{
  ...
  BookmarkManager::Callbacks callbacks(
    ...
    static_cast<BookmarkManager::Callbacks::GetSeacrhAPIFn>(nullptr), onCreate, onUpdate, onDelete, onAttach, onDetach);
...
UNIT_CLASS_TEST(Runner, Bookmarks_TestSaveRoute)
{
  ...
  std::vector const expectedLine = {
    {geometry::PointWithAltitude(m2::PointD(0.0, 0.0)), geometry::PointWithAltitude(m2::PointD(0.001, 0.001))}};
